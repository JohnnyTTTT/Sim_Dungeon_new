...
namespace Johnny.SimDungeon
{
    ...
    {
        public static event Action<Dungeon, DungeonModel, LevelMarkerList> OnDungeonMarkersEmittedAction;


        public override void OnDungeonMarkersEmitted(Dungeon dungeon, DungeonModel model, LevelMarkerList markers)
        {
            OnDungeonMarkersEmittedAction?.Invoke(dungeon, model, markers);
        }
    }
}
