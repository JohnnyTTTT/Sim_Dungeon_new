...
namespace BeautifyHDRP {
    ...
    sealed class BeautifyEditor : VolumeComponentEditor {
        ...
        SerializedDataParameter tonemap, tonemapExposure, tonemapAGXGamma;
        ...
        SerializedDataParameter filmGrain, filmGrainIntensity, filmGrainLumaAttenuation, filmGrainResolution, filmGrainDirtSpotsAmount, filmGrainDirtSpotsIntensity, filmGrainScratchesAmount, filmGrainScratchesIntensity;
        ...
        public override void OnEnable() {
            ...
            tonemapAGXGamma = Unpack(o.Find(x => x.tonemapAGXGamma));
            ...
            filmGrain = Unpack(o.Find(x => x.filmGrain));
            filmGrainIntensity = Unpack(o.Find(x => x.filmGrainIntensity));
            filmGrainLumaAttenuation = Unpack(o.Find(x => x.filmGrainLumaAttenuation));
            filmGrainResolution = Unpack(o.Find(x => x.filmGrainResolution));
            filmGrainDirtSpotsAmount = Unpack(o.Find(x => x.filmGrainDirtSpotsAmount));
            filmGrainDirtSpotsIntensity = Unpack(o.Find(x => x.filmGrainDirtSpotsIntensity));
            filmGrainScratchesAmount = Unpack(o.Find(x => x.filmGrainScratchesAmount));
            filmGrainScratchesIntensity = Unpack(o.Find(x => x.filmGrainScratchesIntensity));
        ...
        public override void OnInspectorGUI() {
            ...
            if (tonemap.value.boolValue) {
                EditorGUI.indentLevel++;
                if (tonemap.value.intValue == (int)Beautify.TonemapOperator.AGX) {
                    PropertyField(tonemapAGXGamma, new GUIContent("Gamma", "Gamma applied to AGX operator"));
                }
            ...
            if (filmGrain.value.boolValue)
            {
                EditorGUI.indentLevel++;
                PropertyField(filmGrainIntensity, new GUIContent("Intensity"));
                PropertyField(filmGrainResolution, new GUIContent("Resolution"));
                PropertyField(filmGrainLumaAttenuation, new GUIContent("Luma Attenuation"));
                PropertyField(filmGrainDirtSpotsAmount, new GUIContent("Dirt Spots Amount"));
                PropertyField(filmGrainDirtSpotsIntensity, new GUIContent("Dirt Spots Intensity"));
                PropertyField(filmGrainScratchesAmount, new GUIContent("Scratches Amount"));
                PropertyField(filmGrainScratchesIntensity, new GUIContent("Scratches Intensity"));
                EditorGUI.indentLevel--;
            }
