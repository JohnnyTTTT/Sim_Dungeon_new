	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 worldToObj82 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS( finalVertexWorldPosition80 ), 1 ) ).xyz;
						 ...
						 )
			{
				...
				surfaceDescription.BaseColor = ( tex2D( _Albedo, uv_Albedo ) * _Tint ).rgb;
...
WireConnection;83;4;70;0
WireConnection;83;7;71;0
WireConnection;83;11;82;0
ASEEND*/
//CHKSM=A112662CECE99E677DFA383555CB0E15D3B4E465