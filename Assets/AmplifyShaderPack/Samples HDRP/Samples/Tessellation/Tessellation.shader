	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_ParallaxMap = inputMesh.uv0.xy * _ParallaxMap_ST.xy + _ParallaxMap_ST.zw;
				float2 uv_ParallaxMapMask = inputMesh.uv0.xy * _ParallaxMapMask_ST.xy + _ParallaxMapMask_ST.zw;
				...
				#endif
				float3 vertexValue = ( ( inputMesh.normalOS * ( (tex2Dlod( _ParallaxMap, float4( uv_ParallaxMap, 0, 0.0) )).rgb * _DisplacementStrength ) ) * (tex2Dlod( _ParallaxMapMask, float4( uv_ParallaxMapMask, 0, 0.0) )).rgb );
						 ...
						 )
			{
				...
				surfaceDescription.Metallic = ( _MetallicStrength * (tex2D( _MetallicGlossMap, temp_output_133_0_g1 )).rgb ).x;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Smoothness = ( _SmoothnessStrength * (tex2D( _SmoothnessMap, temp_output_133_0_g1 )).rgb ).x;
				surfaceDescription.Occlusion = saturate( ( ( 1.0 - _OcclusionStrengthAO ) * (tex2D( _OcclusionMap, temp_output_133_0_g1 )).rgb ) ).x;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_ParallaxMap = inputMesh.ase_texcoord.xy * _ParallaxMap_ST.xy + _ParallaxMap_ST.zw;
				float2 uv_ParallaxMapMask = inputMesh.ase_texcoord.xy * _ParallaxMapMask_ST.xy + _ParallaxMapMask_ST.zw;
...
WireConnection;51;0;30;1
WireConnection;51;1;30;6
WireConnection;51;4;30;3
WireConnection;51;7;30;2
WireConnection;51;8;30;4
WireConnection;51;11;22;0
ASEEND*/
//CHKSM=CEB67F8D600FCFEFEAE8A1AF06401C71C37395C1