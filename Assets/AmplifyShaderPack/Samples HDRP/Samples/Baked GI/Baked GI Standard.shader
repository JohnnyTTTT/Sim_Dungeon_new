	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 temp_output_133_0_g7 = ( ( packedInput.ase_texcoord5.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				...
				surfaceDescription.BaseColor = temp_output_89_0_g7;
				surfaceDescription.Normal = temp_output_33_6;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _MetallicStrength * (SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MainTex, temp_output_133_0_g7 )).rgb ).x;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Smoothness = ( _SmoothnessStrength * (SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_MainTex, temp_output_133_0_g7 )).rgb ).x;
				surfaceDescription.Occlusion = saturate( ( ( 1.0 - _OcclusionStrengthAO ) * (SAMPLE_TEXTURE2D( _OcclusionMap, sampler_MainTex, temp_output_133_0_g7 )).rgb ) ).x;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_output_133_0_g7 = ( ( packedInput.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g7 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g7 );
				float3 temp_output_89_0_g7 = ( (_BaseColor).rgb * (tex2DNode21_g7).rgb * _Brightness );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 temp_output_133_0_g7 = ( ( packedInput.ase_texcoord3.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float3 unpack98_g7 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, temp_output_133_0_g7 ), _NormalStrength );
				unpack98_g7.z = lerp( 1, unpack98_g7.z, saturate(_NormalStrength) );
				float3 temp_output_33_6 = unpack98_g7;
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 temp_output_133_0_g7 = ( ( packedInput.ase_texcoord7.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g7 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g7 );
				float3 temp_output_89_0_g7 = ( (_BaseColor).rgb * (tex2DNode21_g7).rgb * _Brightness );
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;33;-160,0;Inherit;False;Material Sample;0;;7;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;11;FLOAT3;1;FLOAT3;6;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;54;160,224;Inherit;False;Material Baked GI;34;;32;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;3;975;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
