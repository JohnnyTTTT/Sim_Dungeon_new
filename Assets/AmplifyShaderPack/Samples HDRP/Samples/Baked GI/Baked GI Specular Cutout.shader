	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 temp_output_133_0_g14 = ( ( packedInput.ase_texcoord5.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				...
				float2 temp_output_1219_0_g32 = (packedInput.uv1.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g32 = temp_output_1219_0_g32;
				float2 staticUV965_g32 = UV1Static1247_g32;
				float2 temp_output_1255_0_g32 = (packedInput.uv2.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				...
				float4 staticSwitch983_g32 = float4( 34.49324, 2.2, 0, 0 );
				#else
				float4 staticSwitch983_g32 = float4( 2, 2.2, 0, 0 );
				#endif
				#ifdef UNITY_LIGHTMAP_FULL_HDR
				float4 staticSwitch982_g32 = float4( 0, 0, 0, 0 );
				#else
				float4 staticSwitch982_g32 = staticSwitch983_g32;
				#endif
				float4 decodeInstructions965_g32 = staticSwitch982_g32;
				...
				float temp_output_1343_0_g32 = GetCurrentExposureMultiplier();
				...
				float3 temp_output_1345_0_g32 = ( backBakeDiffuseLighting965_g32 * temp_output_1343_0_g32 );
				float3 lerpResult942_g32 = lerp( float3( 0,0,0 ) , temp_output_1345_0_g32 , _BakedGIEnable);
				

				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;

				surfaceDescription.BaseColor = temp_output_89_0_g14;
				surfaceDescription.Normal = temp_output_33_6;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = ( temp_output_202_0_g14 * (SAMPLE_TEXTURE2D( _SpecularMap, sampler_MainTex, temp_output_133_0_g14 )).rgb * _SpecularStrength );
				#endif

				surfaceDescription.Smoothness = ( _SmoothnessStrength * (SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_MainTex, temp_output_133_0_g14 )).rgb ).x;
				surfaceDescription.Occlusion = saturate( ( ( 1.0 - _OcclusionStrengthAO ) * (SAMPLE_TEXTURE2D( _OcclusionMap, sampler_MainTex, temp_output_133_0_g14 )).rgb ) ).x;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = MapBaseColorAlpha107_g14;
				...
				#ifdef ASE_BAKEDGI
				surfaceDescription.BakedGI = lerpResult941_g32;
				#endif
				#ifdef ASE_BAKEDBACKGI
				surfaceDescription.BakedBackGI = lerpResult942_g32;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_output_133_0_g14 = ( ( packedInput.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
				float3 temp_output_89_0_g14 = ( (_BaseColor).rgb * (tex2DNode21_g14).rgb * _Brightness );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 temp_output_133_0_g14 = ( ( packedInput.ase_texcoord3.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
				float MapBaseColorAlpha107_g14 = tex2DNode21_g14.a;
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 temp_output_133_0_g14 = ( ( packedInput.ase_texcoord7.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
				float3 temp_output_89_0_g14 = ( (_BaseColor).rgb * (tex2DNode21_g14).rgb * _Brightness );
