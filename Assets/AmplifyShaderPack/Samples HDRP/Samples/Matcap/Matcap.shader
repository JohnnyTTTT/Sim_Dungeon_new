	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				surfaceDescription.Color = tex2D( _Matcap, ( ( mul( UNITY_MATRIX_V, float4( ase_normalWS , 0.0 ) ).xyz * 0.5 ) + 0.5 ).xy ).rgb;
...
ASEEND*/
//CHKSM=1F920C718C61183299AED76CE18B7A744B765A3D