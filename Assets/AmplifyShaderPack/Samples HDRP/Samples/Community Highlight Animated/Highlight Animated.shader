	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord51 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 hdEmission150 = ASEGetEmissionHDRColor(Final_Emision114.rgb,_EmissionIntensity,_EmissionWeight,GetInverseCurrentExposureMultiplier());
				

				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;

				surfaceDescription.BaseColor = Albedo65.rgb;
				surfaceDescription.Normal = Normal67;
				...
				surfaceDescription.Occlusion = Oclussion86.r;
				surfaceDescription.Emission = hdEmission150;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 texCoord51 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 Albedo65 = ( _Color * tex2D( _Albedo, texCoord51 ) );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord51 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 Normal67 = UnpackNormalScale( tex2D( _Normal, texCoord51 ), 1.0f );
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 texCoord51 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float4 Albedo65 = ( _Color * tex2D( _Albedo, texCoord51 ) );
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;128;-1740.517,-840.847;Float;False;Property;_HighlightSpeed;Highlight Speed;10;0;Create;True;0;0;0;False;0;False;60;60;0;200;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;111;-1819.132,391.7312;Float;False;Property;_Highlighted;Highlighted;11;0;Create;True;0;0;0;False;0;False;0;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;150;0;70;0
WireConnection;150;1;151;0
WireConnection;150;2;152;0
WireConnection;139;0;68;0
WireConnection;139;1;69;0
WireConnection;139;8;76;0
WireConnection;139;6;150;0
ASEEND*/
//CHKSM=0BF91BCEEAE2BC4E8103B378CDE94A7B752D7241