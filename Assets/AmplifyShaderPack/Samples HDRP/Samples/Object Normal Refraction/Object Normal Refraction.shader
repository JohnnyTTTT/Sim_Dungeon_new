	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				output.ase_texcoord5.xyz = inputMesh.uv0.xyz;
						 ...
						 )
			{
				...
				float3 worldRefl46 = reflect( -V, float3( dot( tanToWorld0, tex2DNode54 ), dot( tanToWorld1, tex2DNode54 ), dot( tanToWorld2, tex2DNode54 ) ) );
				

				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;

				surfaceDescription.BaseColor = ( texCUBE( _CubeMap, worldRefl46 ) * 5 ).rgb;
				surfaceDescription.Normal = tex2DNode54;
				...
				surfaceDescription.RefractionIndex = _IndexofRefraction;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				output.ase_texcoord2.xyz = inputMesh.uv0.xyz;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 worldRefl46 = reflect( -ase_viewDirWS, float3( dot( tanToWorld0, tex2DNode54 ), dot( tanToWorld1, tex2DNode54 ), dot( tanToWorld2, tex2DNode54 ) ) );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS output)
			{
				...
				output.ase_texcoord7.xyz = inputMesh.ase_texcoord.xyz;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS output)
			{
				...
				output.ase_texcoord7.xyz = inputMesh.uv0.xyz;
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;52;304.7198,-183.0011;Inherit;False;293.1999;207.6;Multiplier to make it POP;1;53;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;55;-975.6902,141.84;Float;False;Property;_NormalScale;Normal Scale;1;0;Create;True;0;0;0;False;0;False;0.1;0.25;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;54;-646.7961,72.9934;Inherit;True;Property;_NormalMap;Normal Map;0;0;Create;True;0;0;0;False;0;False;-1;None;cd843373d1f443fc9d46351a814d44cf;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;56;7;67;0
WireConnection;56;9;42;0
WireConnection;56;17;41;0
WireConnection;56;18;71;0
WireConnection;56;19;72;0
ASEEND*/
//CHKSM=3E35CDC427B43F706EC991DAE35B842FA4F42008