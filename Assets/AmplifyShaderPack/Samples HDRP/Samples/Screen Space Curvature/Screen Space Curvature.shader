	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 temp_output_2_0 = ddx( NormalWS );
				float3 temp_output_7_0 = ddy( NormalWS );
				...
				surfaceDescription.Emission = ( ( ( ( cross( ( NormalWS - temp_output_2_0 ) , ( NormalWS + temp_output_2_0 ) ).y - cross( ( NormalWS - temp_output_7_0 ) , ( NormalWS + temp_output_7_0 ) ).x ) * _ScaleFactor ) / length( packedInput.ase_texcoord5.xyz ) ) + float3( 0.5, 0.5, 0.5 ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Emission = ( ( ( ( cross( ( ase_normalWS - temp_output_2_0 ) , ( ase_normalWS + temp_output_2_0 ) ).y - cross( ( ase_normalWS - temp_output_7_0 ) , ( ase_normalWS + temp_output_7_0 ) ).x ) * _ScaleFactor ) / length( packedInput.ase_texcoord3.xyz ) ) + float3( 0.5, 0.5, 0.5 ) );
				surfaceDescription.Alpha = 1;
		...
		Pass
		{
					 ...
					 )
			{
				...
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Emission = ( ( ( ( cross( ( NormalWS - temp_output_2_0 ) , ( NormalWS + temp_output_2_0 ) ).y - cross( ( NormalWS - temp_output_7_0 ) , ( NormalWS + temp_output_7_0 ) ).x ) * _ScaleFactor ) / length( packedInput.ase_texcoord7.xyz ) ) + float3( 0.5, 0.5, 0.5 ) );
				surfaceDescription.Alpha = 1;
...
WireConnection;34;6;29;0
ASEEND*/
//CHKSM=CBF69C6CDB8FFE6C31BBD2C96BB0514F91E734BD