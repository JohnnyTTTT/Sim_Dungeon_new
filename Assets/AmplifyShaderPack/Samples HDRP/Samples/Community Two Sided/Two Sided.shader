	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_FrontFacesAlbedo = packedInput.ase_texcoord5.xy * _FrontFacesAlbedo_ST.xy + _FrontFacesAlbedo_ST.zw;
				float4 FrontFacesAlbedo44 = ( _FrontFacesColor * tex2D( _FrontFacesAlbedo, uv_FrontFacesAlbedo ) );
				float2 uv_BackFacesAlbedo = packedInput.ase_texcoord5.xy * _BackFacesAlbedo_ST.xy + _BackFacesAlbedo_ST.zw;
				float4 BackFacesAlbedo47 = ( _BackFacesColor * tex2D( _BackFacesAlbedo, uv_BackFacesAlbedo ) );
				float dotResult20 = dot( NormalWS , V );
				...
				float2 uv_FrontFacesNormal = packedInput.ase_texcoord5.xy * _FrontFacesNormal_ST.xy + _FrontFacesNormal_ST.zw;
				float3 FrontFacesNormal51 = UnpackNormalScale( tex2D( _FrontFacesNormal, uv_FrontFacesNormal ), 1.0f );
				float2 uv_BackFacesNormal = packedInput.ase_texcoord5.xy * _BackFacesNormal_ST.xy + _BackFacesNormal_ST.zw;
				...
				surfaceDescription.BaseColor = lerpResult24.rgb;
				surfaceDescription.Normal = lerpResult64;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_FrontFacesAlbedo = packedInput.ase_texcoord2.xy * _FrontFacesAlbedo_ST.xy + _FrontFacesAlbedo_ST.zw;
				float4 FrontFacesAlbedo44 = ( _FrontFacesColor * tex2D( _FrontFacesAlbedo, uv_FrontFacesAlbedo ) );
				float2 uv_BackFacesAlbedo = packedInput.ase_texcoord2.xy * _BackFacesAlbedo_ST.xy + _BackFacesAlbedo_ST.zw;
				float4 BackFacesAlbedo47 = ( _BackFacesColor * tex2D( _BackFacesAlbedo, uv_BackFacesAlbedo ) );
				...
				float2 uv_FrontFacesNormal = packedInput.ase_texcoord2.xy * _FrontFacesNormal_ST.xy + _FrontFacesNormal_ST.zw;
				float3 FrontFacesNormal51 = UnpackNormalScale( tex2D( _FrontFacesNormal, uv_FrontFacesNormal ), 1.0f );
				float2 uv_BackFacesNormal = packedInput.ase_texcoord2.xy * _BackFacesNormal_ST.xy + _BackFacesNormal_ST.zw;
				float3 BackFacesNormal54 = UnpackNormalScale( tex2D( _BackFacesNormal, uv_BackFacesNormal ), 1.0f );
				float3 lerpResult64 = lerp( FrontFacesNormal51 , BackFacesNormal54 , FaceSign48);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_FrontFacesNormal = packedInput.ase_texcoord3.xy * _FrontFacesNormal_ST.xy + _FrontFacesNormal_ST.zw;
				float3 FrontFacesNormal51 = UnpackNormalScale( tex2D( _FrontFacesNormal, uv_FrontFacesNormal ), 1.0f );
				float2 uv_BackFacesNormal = packedInput.ase_texcoord3.xy * _BackFacesNormal_ST.xy + _BackFacesNormal_ST.zw;
				float3 BackFacesNormal54 = UnpackNormalScale( tex2D( _BackFacesNormal, uv_BackFacesNormal ), 1.0f );
				float dotResult20 = dot( NormalWS , V );
				float FaceSign48 =  (1.0 + ( sign( dotResult20 ) - -1.0 ) * ( 0.0 - 1.0 ) / ( 1.0 - -1.0 ) );
				float3 lerpResult64 = lerp( FrontFacesNormal51 , BackFacesNormal54 , FaceSign48);
		...
		Pass
		{
					 ...
					 )
			{
				...
				float dotResult20 = dot( ase_normalWS , V );
				float FaceSign48 =  (1.0 + ( sign( dotResult20 ) - -1.0 ) * ( 0.0 - 1.0 ) / ( 1.0 - -1.0 ) );
				float3 lerpResult64 = lerp( FrontFacesNormal51 , BackFacesNormal54 , FaceSign48);
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 uv_FrontFacesAlbedo = packedInput.ase_texcoord7.xy * _FrontFacesAlbedo_ST.xy + _FrontFacesAlbedo_ST.zw;
				float4 FrontFacesAlbedo44 = ( _FrontFacesColor * tex2D( _FrontFacesAlbedo, uv_FrontFacesAlbedo ) );
				float2 uv_BackFacesAlbedo = packedInput.ase_texcoord7.xy * _BackFacesAlbedo_ST.xy + _BackFacesAlbedo_ST.zw;
				float4 BackFacesAlbedo47 = ( _BackFacesColor * tex2D( _BackFacesAlbedo, uv_BackFacesAlbedo ) );
				float dotResult20 = dot( NormalWS , V );
				float FaceSign48 =  (1.0 + ( sign( dotResult20 ) - -1.0 ) * ( 0.0 - 1.0 ) / ( 1.0 - -1.0 ) );
				float4 lerpResult24 = lerp( FrontFacesAlbedo44 , BackFacesAlbedo47 , FaceSign48);
				
				float2 uv_FrontFacesNormal = packedInput.ase_texcoord7.xy * _FrontFacesNormal_ST.xy + _FrontFacesNormal_ST.zw;
				float3 FrontFacesNormal51 = UnpackNormalScale( tex2D( _FrontFacesNormal, uv_FrontFacesNormal ), 1.0f );
				float2 uv_BackFacesNormal = packedInput.ase_texcoord7.xy * _BackFacesNormal_ST.xy + _BackFacesNormal_ST.zw;
				float3 BackFacesNormal54 = UnpackNormalScale( tex2D( _BackFacesNormal, uv_BackFacesNormal ), 1.0f );
				float3 lerpResult64 = lerp( FrontFacesNormal51 , BackFacesNormal54 , FaceSign48);
				
				float2 uv_OpacityMask = packedInput.ase_texcoord7.xy * _OpacityMask_ST.xy + _OpacityMask_ST.zw;
				float OpacityMask56 = tex2D( _OpacityMask, uv_OpacityMask ).a;
...
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;27;-564.5056,82.69086;Inherit;True;Property;_OpacityMask;Opacity Mask;6;0;Create;True;0;0;0;False;0;False;-1;None;4a78764018124872b6f511e00fb51f97;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;28;-1708.367,-761.7521;Float;False;Property;_FrontFacesColor;Front Faces Color;0;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;29;-772.7956,-762.0974;Float;False;Property;_BackFacesColor;Back Faces Color;3;0;Create;True;0;0;0;False;0;False;0,0.04827571,1,0;0,0.04827559,1,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;45;-814.2166,-573.6706;Inherit;True;Property;_BackFacesAlbedo;Back Faces Albedo;4;0;Create;True;0;0;0;False;0;False;-1;None;f0325b098cd84bc1a847391f531b3007;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;42;-1726.875,-565.9415;Inherit;True;Property;_FrontFacesAlbedo;Front Faces Albedo;1;0;Create;True;0;0;0;False;0;False;-1;None;da393ef0b6f346bfb12efb2fb851f879;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SignOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;22;-1298.996,161.4731;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;50;-1700.404,-334.5151;Inherit;True;Property;_FrontFacesNormal;Front Faces Normal;2;0;Create;True;0;0;0;False;0;False;-1;None;eca6e6758d6a4dc39ac6f36fd58cd4b1;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;53;-762.2464,-327.8621;Inherit;True;Property;_BackFacesNormal;Back Faces Normal;5;0;Create;True;0;0;0;False;0;False;-1;None;8ec217f770e34536be4d0dee12abb7a6;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.TFHCRemapNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;23;-1136.493,143.3126;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;1;False;4;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;48;-914.667,139.6586;Float;False;FaceSign;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;66;9;58;0
WireConnection;66;10;77;0
ASEEND*/
//CHKSM=51FEC5CE0990DEA72F34CDD1B7204E04C8730B80