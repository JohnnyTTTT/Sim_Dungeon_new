	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				surfaceDescription.Normal = unpack98_g3;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = ( temp_output_202_0_g3 * (tex2D( _SpecularMap, temp_output_133_0_g3 )).rgb * _SpecularStrength );
				#endif
				...
				surfaceDescription.Alpha = ( MapBaseColorAlpha107_g3 * ( ( ( ase_depthLinearEye + -temp_output_73_0 ) / ( _EndDitheringFade - temp_output_73_0 ) ) - dither78 ) );
...
WireConnection;83;0;80;8
WireConnection;83;1;79;0
WireConnection;84;0;80;1
WireConnection;84;1;80;6
WireConnection;84;5;80;5
WireConnection;84;7;80;2
WireConnection;84;8;80;4
WireConnection;84;9;83;0
WireConnection;84;10;80;71
WireConnection;84;30;80;72
ASEEND*/
//CHKSM=C8C4499F047E3036A1DF8AD24983F6705025C457