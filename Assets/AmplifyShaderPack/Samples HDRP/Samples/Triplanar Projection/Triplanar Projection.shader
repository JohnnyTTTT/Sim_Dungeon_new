...
Shader "AmplifyShaderPack/Triplanar Projection"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _TriplanarAlbedo_ST;
			float4 _TopNormal_ST;
			float4 _TriplanarNormal_ST;
						 ...
						 )
			{
				...
				float4 triplanar343 = TriplanarSampling343( _TopAlbedo, _TriplanarAlbedo, _TriplanarAlbedo, PositionWS, NormalWS, _CoverageFalloff, float2( 1,1 ), float3( 1,1,1 ), float3(0,0,0) );
				
				float3x3 ase_worldToTangent = float3x3( TangentWS, BitangentWS, NormalWS );
				float3 triplanar345 = TriplanarSampling345( _TopNormal, _TriplanarNormal, _TriplanarNormal, PositionWS, NormalWS, _CoverageFalloff, float2( 1,1 ), float3( 1,1,1 ), float3(0,0,0) );
				...
				surfaceDescription.BaseColor = triplanar343.xyz;
				surfaceDescription.Normal = tanTriplanarNormal345;
		...
		Pass
		{
					 ...
					 )
			{
				...
				float3 ase_bitangentWS = packedInput.ase_texcoord5.xyz;
				float3x3 ase_worldToTangent = float3x3( ase_tangentWS, ase_bitangentWS, ase_normalWS );
				float3 triplanar345 = TriplanarSampling345( _TopNormal, _TriplanarNormal, _TriplanarNormal, PositionWS, ase_normalWS, _CoverageFalloff, float2( 1,1 ), float3( 1,1,1 ), float3(0,0,0) );
				float3 tanTriplanarNormal345 = mul( ase_worldToTangent, triplanar345 );
...
WireConnection;353;1;345;0
WireConnection;353;5;212;0
WireConnection;353;7;213;0
ASEEND*/
//CHKSM=A00CE38D3E9BCF8331CAFB949E70F98A0BF57751