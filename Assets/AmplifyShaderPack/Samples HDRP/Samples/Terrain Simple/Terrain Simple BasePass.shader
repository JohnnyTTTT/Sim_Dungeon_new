...
Shader "Hidden/AmplifyShaderPack/Terrain/Simple BasePass"
{
	...
	SubShader
	{
		...
		Tags { "RenderPipeline"="HDRenderPipeline" "RenderType"="Opaque" "Queue"="Geometry" "TerrainCompatible"="True" "IgnoreProjector"="True" }
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			Name "GBuffer"
			Tags { "LightMode"="GBuffer" "TerrainCompatible"="True" "IgnoreProjector"="True" }
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 appendResult87_g2 = (float4(cross( inputMesh.normalOS , float3( 0, 0, 1 ) ) , -1.0));
				...
				inputMesh.tangentOS = appendResult87_g2;
						 ...
						 )
			{
				...
				float2 uv_MetallicTex = packedInput.ase_texcoord5.xy * _MetallicTex_ST.xy + _MetallicTex_ST.zw;
				

				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;

				surfaceDescription.BaseColor = lerpResult61_g2;
				surfaceDescription.Normal = float3( 0, 0, 1 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = SAMPLE_TEXTURE2D( _MetallicTex, sampler_MetallicTex, uv_MetallicTex ).r;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Smoothness = tex2DNode2_g2.a;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_MetallicTex = packedInput.ase_texcoord2.xy * _MetallicTex_ST.xy + _MetallicTex_ST.zw;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 uv_MetallicTex = packedInput.ase_texcoord7.xy * _MetallicTex_ST.xy + _MetallicTex_ST.zw;
