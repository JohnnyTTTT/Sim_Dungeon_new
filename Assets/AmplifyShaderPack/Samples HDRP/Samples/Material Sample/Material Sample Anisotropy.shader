...
Shader "AmplifyShaderPack/Material Sample Anisotropy"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_AnisotropyMap = packedInput.ase_texcoord5.xy * _AnisotropyMap_ST.xy + _AnisotropyMap_ST.zw;
				float Anisotropy46 = ( tex2D( _AnisotropyMap, uv_AnisotropyMap ).r * _Anisotropy );
				...
				#ifdef _MATERIAL_FEATURE_ANISOTROPY
				surfaceDescription.Anisotropy = Anisotropy46;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_AnisotropyMap = packedInput.ase_texcoord2.xy * _AnisotropyMap_ST.xy + _AnisotropyMap_ST.zw;
				float Anisotropy46 = ( tex2D( _AnisotropyMap, uv_AnisotropyMap ).r * _Anisotropy );
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 uv_AnisotropyMap = packedInput.ase_texcoord7.xy * _AnisotropyMap_ST.xy + _AnisotropyMap_ST.zw;
				float Anisotropy46 = ( tex2D( _AnisotropyMap, uv_AnisotropyMap ).r * _Anisotropy );
