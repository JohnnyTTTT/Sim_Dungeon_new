	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float4 tex2DNode21_g7 = tex2D( _MainTex, temp_output_133_0_g7 );
				float3 temp_output_89_0_g7 = ( (_BaseColor).rgb * (tex2DNode21_g7).rgb * _Brightness );
				
				float3 unpack98_g7 = UnpackNormalScale( tex2D( _BumpMap, temp_output_133_0_g7 ), _NormalStrength );
				unpack98_g7.z = lerp( 1, unpack98_g7.z, saturate(_NormalStrength) );
				
				float3 temp_output_202_0_g7 = (_SpecularColor).rgb;
				
				float MapBaseColorAlpha107_g7 = tex2DNode21_g7.a;
				

				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;

				surfaceDescription.BaseColor = temp_output_89_0_g7;
				surfaceDescription.Normal = unpack98_g7;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = ( temp_output_202_0_g7 * (tex2D( _SpecularMap, temp_output_133_0_g7 )).rgb * _SpecularStrength );
				#endif

				surfaceDescription.Smoothness = ( _SmoothnessStrength * (tex2D( _SmoothnessMap, temp_output_133_0_g7 )).rgb ).x;
				surfaceDescription.Occlusion = saturate( ( ( 1.0 - _OcclusionStrengthAO ) * (tex2D( _OcclusionMap, temp_output_133_0_g7 )).rgb ) ).x;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = MapBaseColorAlpha107_g7;
