	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_RockAlbedo = packedInput.ase_texcoord5.xy * _RockAlbedo_ST.xy + _RockAlbedo_ST.zw;
				float2 uv_SnowAlbedo = packedInput.ase_texcoord5.xy * _SnowAlbedo_ST.xy + _SnowAlbedo_ST.zw;
				float2 uv_RockNormal = packedInput.ase_texcoord5.xy * _RockNormal_ST.xy + _RockNormal_ST.zw;
				float2 uv_SnowNormal = packedInput.ase_texcoord5.xy * _SnowNormal_ST.xy + _SnowNormal_ST.zw;
				float3 lerpResult15 = lerp( UnpackNormalScale( tex2D( _RockNormal, uv_RockNormal ), 1.0f ) , UnpackNormalScale( tex2D( _SnowNormal, uv_SnowNormal ), 1.0f ) , saturate( ( NormalWS.y * _SnowAmount ) ));
				...
				float2 uv_RockSpecular = packedInput.ase_texcoord5.xy * _RockSpecular_ST.xy + _RockSpecular_ST.zw;
				float2 uv_SnowSpecular = packedInput.ase_texcoord5.xy * _SnowSpecular_ST.xy + _SnowSpecular_ST.zw;
				...
				surfaceDescription.BaseColor = lerpResult10.rgb;
				surfaceDescription.Normal = lerpResult15;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = lerpResult17.rgb;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_RockAlbedo = packedInput.ase_texcoord2.xy * _RockAlbedo_ST.xy + _RockAlbedo_ST.zw;
				float2 uv_SnowAlbedo = packedInput.ase_texcoord2.xy * _SnowAlbedo_ST.xy + _SnowAlbedo_ST.zw;
				float2 uv_RockNormal = packedInput.ase_texcoord2.xy * _RockNormal_ST.xy + _RockNormal_ST.zw;
				float2 uv_SnowNormal = packedInput.ase_texcoord2.xy * _SnowNormal_ST.xy + _SnowNormal_ST.zw;
				float3 ase_normalWS = packedInput.ase_texcoord3.xyz;
				float3 lerpResult15 = lerp( UnpackNormalScale( tex2D( _RockNormal, uv_RockNormal ), 1.0f ) , UnpackNormalScale( tex2D( _SnowNormal, uv_SnowNormal ), 1.0f ) , saturate( ( ase_normalWS.y * _SnowAmount ) ));
				...
				float2 uv_RockSpecular = packedInput.ase_texcoord2.xy * _RockSpecular_ST.xy + _RockSpecular_ST.zw;
				float2 uv_SnowSpecular = packedInput.ase_texcoord2.xy * _SnowSpecular_ST.xy + _SnowSpecular_ST.zw;
				float4 lerpResult17 = lerp( tex2D( _RockSpecular, uv_RockSpecular ) , tex2D( _SnowSpecular, uv_SnowSpecular ) , temp_output_18_0);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_RockNormal = packedInput.ase_texcoord3.xy * _RockNormal_ST.xy + _RockNormal_ST.zw;
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 uv_RockAlbedo = packedInput.ase_texcoord7.xy * _RockAlbedo_ST.xy + _RockAlbedo_ST.zw;
				float2 uv_SnowAlbedo = packedInput.ase_texcoord7.xy * _SnowAlbedo_ST.xy + _SnowAlbedo_ST.zw;
				float2 uv_RockNormal = packedInput.ase_texcoord7.xy * _RockNormal_ST.xy + _RockNormal_ST.zw;
				...
				float2 uv_RockSpecular = packedInput.ase_texcoord7.xy * _RockSpecular_ST.xy + _RockSpecular_ST.zw;
				float2 uv_SnowSpecular = packedInput.ase_texcoord7.xy * _SnowSpecular_ST.xy + _SnowSpecular_ST.zw;
				float4 lerpResult17 = lerp( tex2D( _RockSpecular, uv_RockSpecular ) , tex2D( _SnowSpecular, uv_SnowSpecular ) , temp_output_18_0);
...
WireConnection;23;5;17;0
ASEEND*/
//CHKSM=E5C1E109B0106384A365B8F75B2E4B65BD2920F3