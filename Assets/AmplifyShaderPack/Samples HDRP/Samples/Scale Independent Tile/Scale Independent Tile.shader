	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				output.ase_normal = inputMesh.normalOS;
						 ...
						 )
			{
				...
				float3 normalizeResult4 = normalize( packedInput.ase_normal );
				...
				float2 texCoord15 = packedInput.ase_texcoord5.xy * ( ( ( ZYScale18 * break7.x ) + ( break7.y * XZScale19 ) + ( break7.z * XYScale20 ) ) * _TilingScale ) + _TilingOffset;
				

				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;

				surfaceDescription.BaseColor = tex2D( _Albedo, texCoord15 ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 appendResult5 = (float2(break3.x , break3.y));
				float2 XYScale20 = appendResult5;
				float2 texCoord15 = packedInput.ase_texcoord2.xy * ( ( ( ZYScale18 * break7.x ) + ( break7.y * XZScale19 ) + ( break7.z * XYScale20 ) ) * _TilingScale ) + _TilingOffset;
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 appendResult5 = (float2(break3.x , break3.y));
				float2 XYScale20 = appendResult5;
				float2 texCoord15 = packedInput.ase_texcoord7.xy * ( ( ( ZYScale18 * break7.x ) + ( break7.y * XZScale19 ) + ( break7.z * XYScale20 ) ) * _TilingScale ) + _TilingOffset;
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;25;-1719.92,255.617;Inherit;False;979.3345;423;;8;1;3;5;6;17;20;18;19;Get Object Scale;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ObjectScaleNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1;-1669.92,350.0418;Inherit;True;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.DynamicAppendNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;6;-1127.586,433.6172;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.DynamicAppendNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;5;-1127.586,545.6177;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;17;-1127.586,305.617;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;20;-983.5859,561.6176;Inherit;False;XYScale;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;19;-983.5859,433.6172;Inherit;False;XZScale;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;18;-983.5859,305.617;Inherit;False;ZYScale;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;11;-621.0218,160.3215;Inherit;False;Property;_TilingScale;Tiling Scale;0;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;-404.0218,113.3215;Inherit;False;Property;_TilingOffset;Tiling Offset;1;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
ASEEND*/
//CHKSM=C25F5DFA457BB603AD297B063C55C0AB41D18947