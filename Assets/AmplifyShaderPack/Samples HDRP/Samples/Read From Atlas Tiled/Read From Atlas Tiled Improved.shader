	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				surfaceDescription.BaseColor = (tex2Dlod( _Atlas, float4( ( temp_output_22_0 + ( ( localMyCustomExpression61 * ( ( _Max * appendResult62 ) - temp_output_22_0 ) ) * _TileSize ) ), 0, 0.0) )).rgb;
...
Node;AmplifyShaderEditor.CustomExpressionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;61;-1206.058,-333.8445;Float;False;frac(A/B)*B;2;Create;2;True;A;FLOAT2;0,0;In;;Float;False;True;B;FLOAT2;0,0;In;;Float;False;My Custom Expression;True;False;0;;False;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=9A9478F21DA44F7791BFDB3473F69F2E35CA1011