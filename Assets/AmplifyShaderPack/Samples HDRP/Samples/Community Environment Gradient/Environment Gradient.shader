	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord11 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode13 = tex2D( _R_AO_G_Edges, texCoord11 );
				float saferPower40 = abs( tex2DNode13.r );
				float3 temp_output_22_0 = abs( NormalWS );
				...
				float clampResult32 = clamp( ( PositionWS.y / _GradientHeight ) , 0.0 , 1.0 );
				...
				surfaceDescription.BaseColor = clampResult42.rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _NormalMap, texCoord11 ), 1.0f );
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 texCoord11 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode13 = tex2D( _R_AO_G_Edges, texCoord11 );
				float saferPower40 = abs( tex2DNode13.r );
				float3 temp_output_22_0 = abs( NormalWS );
				float temp_output_23_0 = (( temp_output_22_0 * temp_output_22_0 )).y;
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;73;1587.977,304.1648;Inherit;False;Property;_Smoothness;Smoothness;10;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;8;-2264.451,480.9954;Inherit;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;15;-1914.605,473.5918;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.AbsOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;22;-2057.508,482.0916;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WorldPosInputsNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;7;-2157.531,-140.8377;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
WireConnection;75;7;73;0
ASEEND*/
//CHKSM=DC34B4045EDE3D5F51BFC573F7043502401634E9