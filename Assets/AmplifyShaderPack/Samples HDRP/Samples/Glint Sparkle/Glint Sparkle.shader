	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float staticSwitch495 = packedInput.ase_texcoord6.xyz.x;
				#elif defined( _DIRECTION_Y )
				float staticSwitch495 = packedInput.ase_texcoord6.xyz.y;
				#elif defined( _DIRECTION_Z )
				float staticSwitch495 = packedInput.ase_texcoord6.xyz.z;
				#else
				float staticSwitch495 = packedInput.ase_texcoord6.xyz.y;
				#endif
				...
				float fresnelNdotV400 = dot( worldNormal567, V );
				...
				float fresnelNdotV536 = dot( worldNormal567, V );
				float fresnelNode536 = ( _SparkleFresnel.x + _SparkleFresnel.y * pow( max( 1.0 - fresnelNdotV536 , 0.0001 ), _SparkleFresnel.z ) );
				float fresnelNdotV370 = dot( worldNormal567, V );
				float fresnelNode370 = ( _MainGlowFresnel.x + _MainGlowFresnel.y * pow( max( 1.0 - fresnelNdotV370 , 0.0001 ), _MainGlowFresnel.z ) );
				float3 hdEmission608 = ASEGetEmissionHDRColor(( ( _GlintColor * pow( saferPower487 , 5.0 ) * fresnelNode400 * _Brightness ) + ( _SparkleColor * smoothstepResult364 * _SparklesBrightness * fresnelNode536 ) + ( _BodyGlow * fresnelNode370 ) ).rgb,_EmissionIntensity1,_EmissionWeight1,GetInverseCurrentExposureMultiplier());
				...
				surfaceDescription.Metallic = 0.9;
				...
				surfaceDescription.Emission = hdEmission608;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				#if defined( _DIRECTION_X )
				float staticSwitch495 = packedInput.ase_texcoord3.xyz.x;
				#elif defined( _DIRECTION_Y )
				float staticSwitch495 = packedInput.ase_texcoord3.xyz.y;
				#elif defined( _DIRECTION_Z )
				float staticSwitch495 = packedInput.ase_texcoord3.xyz.z;
				#else
				float staticSwitch495 = packedInput.ase_texcoord3.xyz.y;
				#endif
				#ifdef _INVERTDIRECTION_ON
		...
		Pass
		{
					 ...
					 )
			{
				...
				#if defined( _DIRECTION_X )
				float staticSwitch495 = packedInput.ase_texcoord8.xyz.x;
				#elif defined( _DIRECTION_Y )
				float staticSwitch495 = packedInput.ase_texcoord8.xyz.y;
				#elif defined( _DIRECTION_Z )
				float staticSwitch495 = packedInput.ase_texcoord8.xyz.z;
				#else
				float staticSwitch495 = packedInput.ase_texcoord8.xyz.y;
				#endif
				#ifdef _INVERTDIRECTION_ON
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;515;2448,-416;Float;True;Property;_Noise;Noise;12;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;62695c15a49d430abd2ae1471c72b1c7;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;355;2704,-176;Float;False;Property;_Frequency;Frequency;13;0;Create;True;0;0;0;False;0;False;20;4;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;511;2656,-32;Float;False;Property;_SpakleSpeed;Spakle Speed;17;0;Create;True;0;0;0;False;0;False;0;0.002;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;557;2672,-480;Float;False;Property;_ScreenContribution;Screen Contribution;18;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;369;3648,112;Float;False;Property;_Range;Range;15;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;367;3648,32;Float;False;Property;_Threshold;Threshold;14;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;571;4208,0;Float;False;Property;_SparkleFresnel;Fresnel Bias, Scale, Power;19;0;Create;False;0;0;0;False;0;False;0,0,0;0.02,0.8,2;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;572;4264.248,588.1351;Float;False;Property;_MainGlowFresnel;Fresnel Bias, Scale, Power;21;0;Create;False;0;0;0;False;0;False;0,0,0;0.02,1,5;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;550;4672,382.1486;Float;False;Property;_BodyGlow;Color;20;0;Create;False;0;0;0;False;1;Header(Body Glow);False;0,0,0,0;0.6323529,0.4794762,0,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;419;4576,-160;Float;False;Property;_SparklesBrightness;Brightness;16;0;Create;False;0;0;0;False;0;False;2;5;0;0;0;1;FLOAT;0
...
WireConnection;608;0;374;0
WireConnection;608;1;606;0
WireConnection;608;2;607;0
WireConnection;595;0;292;0
WireConnection;595;1;565;0
WireConnection;595;4;345;0
WireConnection;595;7;345;0
WireConnection;595;6;608;0
ASEEND*/
//CHKSM=004B427DFFB5FFC2C1B62C85A5F70C914DB8EDFF