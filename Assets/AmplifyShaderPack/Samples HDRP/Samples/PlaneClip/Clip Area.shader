...
Shader "AmplifyShaderPack/Plane Clip Area"
{
	Properties
	{
		...
		_EmissionIntensity2( "Emission Intensity", Float ) = 1
		_EmissionWeight2( "Emission Weight", Float ) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord48 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + temp_cast_0;
				float screenDepth37 = LinearEyeDepth(SampleCameraDepth( ScreenPosNorm.xy ),_ZBufferParams);
				float distanceDepth37 = abs( ( screenDepth37 - LinearEyeDepth( ScreenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
				...
				float3 hdEmission74 = ASEGetEmissionHDRColor(( _Color * _Intensity * temp_output_46_0 ).rgb,_EmissionIntensity2,_EmissionWeight2,GetInverseCurrentExposureMultiplier());
				...
				float2 temp_output_11_0_g4 = ( abs( (frac( (packedInput.ase_texcoord5.xy*temp_cast_2 + float2( 0,0 )) )*2.0 + -1.0) ) - appendResult10_g4 );
				...
				surfaceDescription.Emission = hdEmission74;
				surfaceDescription.Alpha = ( temp_output_46_0 * ( 1.0 - ( 0.4 * saturate( min( break16_g4.x , break16_g4.y ) ) ) ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_cast_0 = (-0.5).xx;
				float2 texCoord48 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + temp_cast_0;
				float4 screenPos = packedInput.ase_texcoord3;
				float4 ase_positionSSNorm = screenPos / screenPos.w;
				ase_positionSSNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_positionSSNorm.z : ase_positionSSNorm.z * 0.5 + 0.5;
				float screenDepth37 = LinearEyeDepth(SampleCameraDepth( ase_positionSSNorm.xy ),_ZBufferParams);
				float distanceDepth37 = abs( ( screenDepth37 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
				float lerpResult38 = lerp( 0.0 , _DepthRange , distanceDepth37);
				float temp_output_46_0 = (  (0.0 + ( pow( length( texCoord48 ) , _EdgeGain ) - 0.0 ) * ( 1.0 - 0.0 ) / ( _EdgeContrast - 0.0 ) ) + saturate( ( 1.0 - lerpResult38 ) ) );
				float3 hdEmission74 = ASEGetEmissionHDRColor(( _Color * _Intensity * temp_output_46_0 ).rgb,_EmissionIntensity2,_EmissionWeight2,GetInverseCurrentExposureMultiplier());
				...
				float temp_output_2_0_g1 = _GridSize;
				float2 appendResult10_g4 = (float2(temp_output_2_0_g1 , temp_output_2_0_g1));
				float2 temp_output_11_0_g4 = ( abs( (frac( (packedInput.ase_texcoord2.xy*temp_cast_2 + float2( 0,0 )) )*2.0 + -1.0) ) - appendResult10_g4 );
				float2 break16_g4 = ( 1.0 - ( temp_output_11_0_g4 / max( fwidth( temp_output_11_0_g4 ) , float2( 1E-05,1E-05 ) ) ) );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 temp_cast_0 = (-0.5).xx;
				float2 texCoord48 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + temp_cast_0;
				float screenDepth37 = LinearEyeDepth(SampleCameraDepth( ScreenPosNorm.xy ),_ZBufferParams);
				float distanceDepth37 = abs( ( screenDepth37 - LinearEyeDepth( ScreenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
				float lerpResult38 = lerp( 0.0 , _DepthRange , distanceDepth37);
				float temp_output_46_0 = (  (0.0 + ( pow( length( texCoord48 ) , _EdgeGain ) - 0.0 ) * ( 1.0 - 0.0 ) / ( _EdgeContrast - 0.0 ) ) + saturate( ( 1.0 - lerpResult38 ) ) );
				...
				float temp_output_2_0_g1 = _GridSize;
				float2 appendResult10_g4 = (float2(temp_output_2_0_g1 , temp_output_2_0_g1));
				float2 temp_output_11_0_g4 = ( abs( (frac( (packedInput.ase_texcoord3.xy*temp_cast_1 + float2( 0,0 )) )*2.0 + -1.0) ) - appendResult10_g4 );
				float2 break16_g4 = ( 1.0 - ( temp_output_11_0_g4 / max( fwidth( temp_output_11_0_g4 ) , float2( 1E-05,1E-05 ) ) ) );
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 temp_cast_0 = (-0.5).xx;
				float2 texCoord48 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + temp_cast_0;
				float screenDepth37 = LinearEyeDepth(SampleCameraDepth( ScreenPosNorm.xy ),_ZBufferParams);
				float distanceDepth37 = abs( ( screenDepth37 - LinearEyeDepth( ScreenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
				float lerpResult38 = lerp( 0.0 , _DepthRange , distanceDepth37);
				float temp_output_46_0 = (  (0.0 + ( pow( length( texCoord48 ) , _EdgeGain ) - 0.0 ) * ( 1.0 - 0.0 ) / ( _EdgeContrast - 0.0 ) ) + saturate( ( 1.0 - lerpResult38 ) ) );
				...
				float temp_output_2_0_g1 = _GridSize;
				float2 appendResult10_g4 = (float2(temp_output_2_0_g1 , temp_output_2_0_g1));
				float2 temp_output_11_0_g4 = ( abs( (frac( (packedInput.ase_texcoord7.xy*temp_cast_2 + float2( 0,0 )) )*2.0 + -1.0) ) - appendResult10_g4 );
				float2 break16_g4 = ( 1.0 - ( temp_output_11_0_g4 / max( fwidth( temp_output_11_0_g4 ) , float2( 1E-05,1E-05 ) ) ) );
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;39;-1580.33,391.9267;Inherit;False;Property;_DepthRange;Depth Range;3;0;Create;True;0;0;0;False;0;False;0;4.92;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;64;-1191.779,780.7765;Inherit;False;Property;_GridSize;Grid Size;8;0;Create;True;0;0;0;False;0;False;0;0.86;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;63;-1200.558,616.4779;Inherit;False;Property;_GridTile;Grid Tile;7;0;Create;True;0;0;0;False;0;False;0;71.58;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;53;-1697.431,97.36664;Inherit;False;Property;_EdgeGain;Edge Gain;4;0;Create;True;0;0;0;False;0;False;0;1.77;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;57;-1379.296,238.9564;Inherit;False;Property;_EdgeContrast;Edge Contrast;6;0;Create;True;0;0;0;False;0;False;0.54;0.42;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;59;-889.6507,-149.9966;Inherit;False;Property;_Intensity;Intensity;5;0;Create;True;0;0;0;False;0;False;0;1.5;0;0;0;1;FLOAT;0
...
WireConnection;75;6;74;0
WireConnection;75;9;71;0
ASEEND*/
//CHKSM=41B05355EE45ABABC3E01058601E7648C96161B5