	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float scaledFace15 = (IsFrontFace*0.5 + 0.5);
				float2 uv_Textured_Course_AlbedoTransparency = packedInput.ase_texcoord5.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
				float dotResult3 = dot( (_PlaneClipNormals).xyz , PositionWS );
				...
				surfaceDescription.BaseColor = ( scaledFace15 * tex2D( _Textured_Course_AlbedoTransparency, uv_Textured_Course_AlbedoTransparency ) ).rgb;
				...
				surfaceDescription.Smoothness = ( scaledFace15 * tex2D( _Smoothness, uv_Smoothness ).r );
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Emission = lerpResult19.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float scaledFace15 = (isFrontFace*0.5 + 0.5);
				float2 uv_Textured_Course_AlbedoTransparency = packedInput.ase_texcoord2.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
		...
		Pass
		{
					 ...
					 )
			{
				...
				float scaledFace15 = (IsFrontFace*0.5 + 0.5);
				float2 uv_Textured_Course_AlbedoTransparency = packedInput.ase_texcoord7.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
				float dotResult3 = dot( (_PlaneClipNormals).xyz , PositionWS );
				clip( (( _ActivateClip )?( -( dotResult3 + _PlaneClipNormals.w ) ):( 0.0 )) );
				
				float2 uv_Smoothness = packedInput.ase_texcoord7.xy * _Smoothness_ST.xy + _Smoothness_ST.zw;
...
WireConnection;46;7;37;0
WireConnection;46;6;19;0
ASEEND*/
//CHKSM=16B5C4CE6F979DEEE405A868EDAFD69D6D0209BA