...
Shader "AmplifyShaderPack/Material Sample Fabric Silk"
{
	Properties
	{
		...
		[Header(ANISOTROPY)][SingleLineTexture][Space(10)] _AnisotropyMap( "Anisotropy Map", 2D ) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 vertexToFrag422_g41 = ( ( ( ( ( inputMesh.ase_texcoord.xy * _BaseAffectUVchannel0 ) + ( inputMesh.uv1.xy * _BaseAffectUVchannel1 ) ) + ( ( inputMesh.uv2.xy * _BaseAffectUVchannel2 ) + ( inputMesh.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord5.xy = vertexToFrag422_g41;
				...
				)
			{
				...
				float2 vertexToFrag422_g41 = packedInput.ase_texcoord5.xy;
				float2 UVBase420_g41 = vertexToFrag422_g41;
				float4 tex2DNode21_g41 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UVBase420_g41 );
				float3 temp_output_73_0_g41 = (tex2DNode21_g41).rgb;
				float3 normalizedWorldNormal = normalize( normalWS );
				float dotResult460_g41 = dot( normalizedWorldNormal , V );
				float TwoSidedSign443_g41 =  (1.0 + ( sign( dotResult460_g41 ) - -1.0 ) * ( 0.0 - 1.0 ) / ( 1.0 - -1.0 ) );
				float3 lerpResult505_g41 = lerp( ( (_BaseColor1).rgb * temp_output_73_0_g41 * _BaseBrightnessFrontFace ) , ( (_BaseColorBackFace).rgb * temp_output_73_0_g41 * _BaseBrightnessBackFace ) , TwoSidedSign443_g41);
				
				float3 unpack98_g41 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UVBase420_g41 ), _NormalStrength );
				unpack98_g41.z = lerp( 1, unpack98_g41.z, saturate(_NormalStrength) );
				
				float3 BaseColor565_g41 = lerpResult505_g41;
				float3 temp_output_202_0_g41 = (_SpecularColor).rgb;
				float temp_output_265_0_g41 = ( ( 1.0 - _SpecularColorIOR ) / ( _SpecularColorIOR + 1.0 ) );
				float3 temp_output_176_0_g41 = ( ( 1.0 - _OcclusionStrengthAO ) * (SAMPLE_TEXTURE2D( _OcclusionMap, sampler_OcclusionMap, UVBase420_g41 )).rgb );
				float3 temp_output_144_0_g41 = saturate( temp_output_176_0_g41 );
				float3 Occlusion571_g41 = temp_output_144_0_g41;
				
				float3 temp_output_175_0_g41 = ( _SmoothnessStrength * (SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_SmoothnessMap, UVBase420_g41 )).rgb );
				
				float2 uv_AnisotropyMap = packedInput.ase_texcoord5.zw * _AnisotropyMap_ST.xy + _AnisotropyMap_ST.zw;
				float Anisotropy72 = ( SAMPLE_TEXTURE2D( _AnisotropyMap, sampler_AnisotropyMap, uv_AnisotropyMap ).r * _Anisotropy );
				
				surfaceDescription.BaseColor = lerpResult505_g41;
				surfaceDescription.Normal = unpack98_g41;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.Specular = ( BaseColor565_g41 * ( ( ( temp_output_202_0_g41 * _SpecularColorWeight ) * ( temp_output_265_0_g41 * temp_output_265_0_g41 ) ) * (SAMPLE_TEXTURE2D( _SpecularMap, sampler_SpecularMap, UVBase420_g41 )).rgb * _SpecularStrength ) * Occlusion571_g41 );

				surfaceDescription.Emission = 0;
				surfaceDescription.Smoothness = saturate( temp_output_175_0_g41 ).x;
				surfaceDescription.Occlusion = temp_output_144_0_g41.x;
				...
				#ifdef _MATERIAL_FEATURE_ANISOTROPY
				surfaceDescription.Anisotropy = Anisotropy72;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction( AttributesMesh inputMesh  )
			{
				...
				float2 vertexToFrag422_g41 = ( ( ( ( ( inputMesh.ase_texcoord.xy * _BaseAffectUVchannel0 ) + ( inputMesh.ase_texcoord1.xy * _BaseAffectUVchannel1 ) ) + ( ( inputMesh.ase_texcoord2.xy * _BaseAffectUVchannel2 ) + ( inputMesh.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				o.ase_texcoord3.xy = vertexToFrag422_g41;
				...
				)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 vertexToFrag422_g41 = packedInput.ase_texcoord3.xy;
				float2 UVBase420_g41 = vertexToFrag422_g41;
				float3 unpack98_g41 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UVBase420_g41 ), _NormalStrength );
				unpack98_g41.z = lerp( 1, unpack98_g41.z, saturate(_NormalStrength) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction( AttributesMesh inputMesh  )
			{
				...
				float2 vertexToFrag422_g41 = ( ( ( ( ( inputMesh.uv0.xy * _BaseAffectUVchannel0 ) + ( inputMesh.uv1.xy * _BaseAffectUVchannel1 ) ) + ( ( inputMesh.uv2.xy * _BaseAffectUVchannel2 ) + ( inputMesh.uv3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				o.ase_texcoord2.xy = vertexToFrag422_g41;
				...
				o.ase_texcoord2.zw = inputMesh.uv0.xy;
			...
			float4 Frag( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 vertexToFrag422_g41 = packedInput.ase_texcoord2.xy;
				float2 UVBase420_g41 = vertexToFrag422_g41;
				float3 unpack98_g41 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UVBase420_g41 ), _NormalStrength );
				unpack98_g41.z = lerp( 1, unpack98_g41.z, saturate(_NormalStrength) );
				...
				float dotResult460_g41 = dot( normalizedWorldNormal , ase_viewDirSafeWS );
				float TwoSidedSign443_g41 =  (1.0 + ( sign( dotResult460_g41 ) - -1.0 ) * ( 0.0 - 1.0 ) / ( 1.0 - -1.0 ) );
				float3 lerpResult505_g41 = lerp( ( (_BaseColor1).rgb * temp_output_73_0_g41 * _BaseBrightnessFrontFace ) , ( (_BaseColorBackFace).rgb * temp_output_73_0_g41 * _BaseBrightnessBackFace ) , TwoSidedSign443_g41);
				float3 BaseColor565_g41 = lerpResult505_g41;
				float3 temp_output_202_0_g41 = (_SpecularColor).rgb;
				...
				float2 uv_AnisotropyMap = packedInput.ase_texcoord2.zw * _AnisotropyMap_ST.xy + _AnisotropyMap_ST.zw;
				float Anisotropy72 = ( SAMPLE_TEXTURE2D( _AnisotropyMap, sampler_AnisotropyMap, uv_AnisotropyMap ).r * _Anisotropy );
		...
		Pass
		{
			...
			PackedVaryingsToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 vertexToFrag422_g41 = ( ( ( ( ( inputMesh.ase_texcoord.xy * _BaseAffectUVchannel0 ) + ( inputMesh.ase_texcoord1.xy * _BaseAffectUVchannel1 ) ) + ( ( inputMesh.ase_texcoord2.xy * _BaseAffectUVchannel2 ) + ( inputMesh.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				outputPackedVaryingsToPS.ase_texcoord3.xy = vertexToFrag422_g41;
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;69;-1170.659,481.7707;Inherit;False;1173.816;435.8067;Anisotropy Map;7;76;75;74;73;72;71;70;;0,0,0,1;0;0
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;73;-861.1768,738.605;Inherit;False;261;140;Anisotropy Map;;0,0,0,1;The highlights of Anisotropic surfaces change in appearance as you view the Material from different angles;0;0
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;74;-548.1769,724.605;Inherit;False;478;177;Anisotropy;;0,0,0,1;Use the float to set the direction of the anisotropy effect. $$Negative values make the effect vertical, and positive values make the effect horizontal. $$This stretches the specular highlights in the given direction.;0;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;70;-867.5023,550.6497;Inherit;True;Property;_TextureSample3;Texture Sample 0;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;71;-369.3393,576.9317;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;72;-221.7243,568.4874;Inherit;False;Anisotropy;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;75;-1142.105,550.2499;Inherit;True;Property;_AnisotropyMap;Anisotropy Map;43;2;[Header];[SingleLineTexture];Create;False;1;ANISOTROPY;0;0;False;1;Space(10);False;None;None;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;76;-547.6302,651.8595;Half;False;Property;_Anisotropy;Anisotropy;44;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DiffusionProfileNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;78;-217.6225,327.2255;Float;False;Property;_DiffusionProfileHash;Diffusion Profile;42;0;Create;False;1;;0;0;False;0;False;0;0;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;77;-141.5527,400.7684;Inherit;False;72;Anisotropy;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;79;-266.323,92.28116;Inherit;False;Material Sample Fabirc;0;;41;17ec3236ec20390488bb6a4bcf57c048;5,263,1,486,0,527,0,543,0,389,0;0;8;FLOAT3;1;FLOAT3;6;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;47;129.9,91.3;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;16;AmplifyShaderPack/Material Sample Fabric Silk;41e04be03f2c20941bc749271be1c937;True;ForwardOnly;0;0;ForwardOnly;21;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=HDLitShader=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;True;2;5;False;;10;False;;0;1;False;;0;False;;False;False;True;1;1;False;;0;True;_DstBlend2;0;1;False;;0;False;;False;False;True;1;1;False;;0;True;_DstBlend2;0;1;False;;0;False;;False;False;False;False;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVelOne;False;True;True;True;True;True;0;True;_ColorMaskTransparentVelTwo;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;False;False;True;1;LightMode=ForwardOnly;False;False;0;;0;0;Standard;31;Surface Type;0;0;  Blend Preserves Specular;1;0;  Depth Write;0;0;  Cull Mode;0;0;  Depth Test;4;0;  Subsurface Scattering;0;0;Alpha Clipping;0;0;Double-Sided;0;0;Energy Conserving Specular;1;0;Material Type;1;638263372926734019;Transmission;0;0;Receive Decals;1;0;Receives SSR;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;  Conserative;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;8;True;True;True;True;True;True;True;True;False;;True;0
