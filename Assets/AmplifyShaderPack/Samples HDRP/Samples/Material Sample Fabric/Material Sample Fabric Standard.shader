	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 vertexToFrag422_g24 = ( ( ( ( ( inputMesh.uv0.xy * _BaseAffectUVchannel0 ) + ( inputMesh.uv1.xy * _BaseAffectUVchannel1 ) ) + ( ( inputMesh.uv2.xy * _BaseAffectUVchannel2 ) + ( inputMesh.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				output.ase_texcoord5.xy = vertexToFrag422_g24;
				float2 temp_output_412_0_g24 = ( ( ( inputMesh.uv0.xy * _ThreadMaskUVAffectchannel0 ) + ( inputMesh.uv1.xy * _ThreadMaskUVAffectchannel1 ) ) + ( ( inputMesh.uv2.xy * _ThreadMaskUVAffectchannel2 ) + ( inputMesh.ase_texcoord3.xy * _ThreadMaskUVAffectchannel3 ) ) );
				float2 vertexToFrag427_g24 = ( ( temp_output_412_0_g24 * (_FuzzMaskUV).xy ) + (_FuzzMaskUV).zw );
				output.ase_texcoord5.zw = vertexToFrag427_g24;
				
				float2 vertexToFrag432_g24 = ( ( temp_output_412_0_g24 * (_ThreadMaskUV).xy ) + (_ThreadMaskUV).zw );
				output.ase_texcoord6.xy = vertexToFrag432_g24;
						 ...
						 )
			{
				...
				float2 vertexToFrag422_g24 = packedInput.ase_texcoord5.xy;
				...
				float dotResult460_g24 = dot( normalizedWorldNormal , V );
				...
				float2 vertexToFrag427_g24 = packedInput.ase_texcoord5.zw;
				...
				float2 vertexToFrag432_g24 = packedInput.ase_texcoord6.xy;
				...
				surfaceDescription.BaseColor = lerpResult388_g24;
				surfaceDescription.Normal = lerpResult485_g24;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = ( BaseColor565_g24 * ( ( ( temp_output_202_0_g24 * _SpecularColorWeight ) * ( temp_output_265_0_g24 * temp_output_265_0_g24 ) ) * (SAMPLE_TEXTURE2D( _SpecularMap, sampler_SpecularMap, UVBase420_g24 )).rgb * _SpecularStrength ) * Occlusion571_g24 );
				#endif

				surfaceDescription.Smoothness = saturate( lerpResult526_g24 ).x;
				surfaceDescription.Occlusion = temp_output_144_0_g24.x;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 vertexToFrag422_g24 = ( ( ( ( ( inputMesh.uv0.xy * _BaseAffectUVchannel0 ) + ( inputMesh.uv1.xy * _BaseAffectUVchannel1 ) ) + ( ( inputMesh.uv2.xy * _BaseAffectUVchannel2 ) + ( inputMesh.uv3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				output.ase_texcoord2.xy = vertexToFrag422_g24;
				...
				float2 temp_output_412_0_g24 = ( ( ( inputMesh.uv0.xy * _ThreadMaskUVAffectchannel0 ) + ( inputMesh.uv1.xy * _ThreadMaskUVAffectchannel1 ) ) + ( ( inputMesh.uv2.xy * _ThreadMaskUVAffectchannel2 ) + ( inputMesh.uv3.xy * _ThreadMaskUVAffectchannel3 ) ) );
				float2 vertexToFrag427_g24 = ( ( temp_output_412_0_g24 * (_FuzzMaskUV).xy ) + (_FuzzMaskUV).zw );
				output.ase_texcoord2.zw = vertexToFrag427_g24;
				
				float2 vertexToFrag432_g24 = ( ( temp_output_412_0_g24 * (_ThreadMaskUV).xy ) + (_ThreadMaskUV).zw );
				output.ase_texcoord5.xy = vertexToFrag432_g24;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 vertexToFrag422_g24 = packedInput.ase_texcoord2.xy;
				float2 UVBase420_g24 = vertexToFrag422_g24;
				float4 tex2DNode21_g24 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UVBase420_g24 );
				float3 temp_output_73_0_g24 = (tex2DNode21_g24).rgb;
				...
				float dotResult460_g24 = dot( normalizedWorldNormal , ase_viewDirSafeWS );
				float TwoSidedSign443_g24 =  (1.0 + ( sign( dotResult460_g24 ) - -1.0 ) * ( 0.0 - 1.0 ) / ( 1.0 - -1.0 ) );
				float3 lerpResult505_g24 = lerp( ( (_BaseColor1).rgb * temp_output_73_0_g24 * _BaseBrightnessFrontFace ) , ( (_BaseColorBackFace).rgb * temp_output_73_0_g24 * _BaseBrightnessBackFace ) , TwoSidedSign443_g24);
				float3 temp_cast_0 = (0.0).xxx;
				float2 vertexToFrag427_g24 = packedInput.ase_texcoord2.zw;
				float2 UVFuzz441_g24 = vertexToFrag427_g24;
				float3 lerpResult382_g24 = lerp( temp_cast_0 , ( (_FuzzMaskColor).rgb * SAMPLE_TEXTURE2D( _FuzzMaskMap, sampler_FuzzMaskMap, UVFuzz441_g24 ).r ) , _FuzzMaskStrength);
				float3 lerpResult388_g24 = lerp( lerpResult505_g24 , saturate( ( lerpResult505_g24 + lerpResult382_g24 ) ) , _FuzzMaskEnable);
				...
				float3 unpack98_g24 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UVBase420_g24 ), _NormalStrength );
				unpack98_g24.z = lerp( 1, unpack98_g24.z, saturate(_NormalStrength) );
				float2 vertexToFrag432_g24 = packedInput.ase_texcoord5.xy;
				float2 UVThread440_g24 = vertexToFrag432_g24;
				float3 unpack475_g24 = UnpackNormalScale( SAMPLE_TEXTURE2D( _ThreadNormalMap, sampler_BumpMap, UVThread440_g24 ), _ThreadNormalStrength );
				unpack475_g24.z = lerp( 1, unpack475_g24.z, saturate(_ThreadNormalStrength) );
				float layeredBlendVar482_g24 = 0.5;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 vertexToFrag422_g24 = ( ( ( ( ( inputMesh.uv0.xy * _BaseAffectUVchannel0 ) + ( inputMesh.ase_texcoord1.xy * _BaseAffectUVchannel1 ) ) + ( ( inputMesh.ase_texcoord2.xy * _BaseAffectUVchannel2 ) + ( inputMesh.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				output.ase_texcoord3.xy = vertexToFrag422_g24;
				float2 temp_output_412_0_g24 = ( ( ( inputMesh.uv0.xy * _ThreadMaskUVAffectchannel0 ) + ( inputMesh.ase_texcoord1.xy * _ThreadMaskUVAffectchannel1 ) ) + ( ( inputMesh.ase_texcoord2.xy * _ThreadMaskUVAffectchannel2 ) + ( inputMesh.ase_texcoord3.xy * _ThreadMaskUVAffectchannel3 ) ) );
				float2 vertexToFrag432_g24 = ( ( temp_output_412_0_g24 * (_ThreadMaskUV).xy ) + (_ThreadMaskUV).zw );
				output.ase_texcoord3.zw = vertexToFrag432_g24;
						 ...
						 )
			{
				...
				float2 vertexToFrag422_g24 = packedInput.ase_texcoord3.xy;
				float2 UVBase420_g24 = vertexToFrag422_g24;
				float3 unpack98_g24 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UVBase420_g24 ), _NormalStrength );
				unpack98_g24.z = lerp( 1, unpack98_g24.z, saturate(_NormalStrength) );
				float2 vertexToFrag432_g24 = packedInput.ase_texcoord3.zw;
				float2 UVThread440_g24 = vertexToFrag432_g24;
				float3 unpack475_g24 = UnpackNormalScale( SAMPLE_TEXTURE2D( _ThreadNormalMap, sampler_BumpMap, UVThread440_g24 ), _ThreadNormalStrength );
				unpack475_g24.z = lerp( 1, unpack475_g24.z, saturate(_ThreadNormalStrength) );
				float layeredBlendVar482_g24 = 0.5;
				...
				float4 tex2DNode493_g24 = SAMPLE_TEXTURE2D( _ThreadMaskMap, sampler_ThreadMaskMap, UVBase420_g24 );
				float MASK_G_Thread491_g24 = tex2DNode493_g24.g;
				float3 lerpResult560_g24 = lerp( temp_output_175_0_g24 , temp_cast_3 , MASK_G_Thread491_g24);
				float EnableThreadMap534_g24 = _ThreadMaskEnable;
				float3 lerpResult526_g24 = lerp( temp_output_175_0_g24 , ( temp_output_175_0_g24 + lerpResult560_g24 ) , EnableThreadMap534_g24);
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS output)
			{
				...
				float2 vertexToFrag422_g24 = ( ( ( ( ( inputMesh.ase_texcoord.xy * _BaseAffectUVchannel0 ) + ( inputMesh.ase_texcoord1.xy * _BaseAffectUVchannel1 ) ) + ( ( inputMesh.ase_texcoord2.xy * _BaseAffectUVchannel2 ) + ( inputMesh.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				output.ase_texcoord3.xy = vertexToFrag422_g24;
				float2 temp_output_412_0_g24 = ( ( ( inputMesh.ase_texcoord.xy * _ThreadMaskUVAffectchannel0 ) + ( inputMesh.ase_texcoord1.xy * _ThreadMaskUVAffectchannel1 ) ) + ( ( inputMesh.ase_texcoord2.xy * _ThreadMaskUVAffectchannel2 ) + ( inputMesh.ase_texcoord3.xy * _ThreadMaskUVAffectchannel3 ) ) );
				float2 vertexToFrag432_g24 = ( ( temp_output_412_0_g24 * (_ThreadMaskUV).xy ) + (_ThreadMaskUV).zw );
				output.ase_texcoord3.zw = vertexToFrag432_g24;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS output)
			{
				...
				float2 vertexToFrag422_g24 = ( ( ( ( ( inputMesh.uv0.xy * _BaseAffectUVchannel0 ) + ( inputMesh.uv1.xy * _BaseAffectUVchannel1 ) ) + ( ( inputMesh.uv2.xy * _BaseAffectUVchannel2 ) + ( inputMesh.ase_texcoord3.xy * _BaseAffectUVchannel3 ) ) ) * (_BaseMainUV).xy ) + (_BaseMainUV).zw );
				output.ase_texcoord7.xy = vertexToFrag422_g24;
				float2 temp_output_412_0_g24 = ( ( ( inputMesh.uv0.xy * _ThreadMaskUVAffectchannel0 ) + ( inputMesh.uv1.xy * _ThreadMaskUVAffectchannel1 ) ) + ( ( inputMesh.uv2.xy * _ThreadMaskUVAffectchannel2 ) + ( inputMesh.ase_texcoord3.xy * _ThreadMaskUVAffectchannel3 ) ) );
				float2 vertexToFrag427_g24 = ( ( temp_output_412_0_g24 * (_FuzzMaskUV).xy ) + (_FuzzMaskUV).zw );
				output.ase_texcoord7.zw = vertexToFrag427_g24;
				
				float2 vertexToFrag432_g24 = ( ( temp_output_412_0_g24 * (_ThreadMaskUV).xy ) + (_ThreadMaskUV).zw );
				output.ase_texcoord8.xy = vertexToFrag432_g24;
					 ...
					 )
			{
				...
				float2 vertexToFrag422_g24 = packedInput.ase_texcoord7.xy;
				float2 UVBase420_g24 = vertexToFrag422_g24;
				float4 tex2DNode21_g24 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, UVBase420_g24 );
				float3 temp_output_73_0_g24 = (tex2DNode21_g24).rgb;
				float3 normalizedWorldNormal = normalize( NormalWS );
				...
				float3 lerpResult505_g24 = lerp( ( (_BaseColor1).rgb * temp_output_73_0_g24 * _BaseBrightnessFrontFace ) , ( (_BaseColorBackFace).rgb * temp_output_73_0_g24 * _BaseBrightnessBackFace ) , TwoSidedSign443_g24);
				float3 temp_cast_0 = (0.0).xxx;
				float2 vertexToFrag427_g24 = packedInput.ase_texcoord7.zw;
				float2 UVFuzz441_g24 = vertexToFrag427_g24;
				float3 lerpResult382_g24 = lerp( temp_cast_0 , ( (_FuzzMaskColor).rgb * SAMPLE_TEXTURE2D( _FuzzMaskMap, sampler_FuzzMaskMap, UVFuzz441_g24 ).r ) , _FuzzMaskStrength);
				float3 lerpResult388_g24 = lerp( lerpResult505_g24 , saturate( ( lerpResult505_g24 + lerpResult382_g24 ) ) , _FuzzMaskEnable);
				...
				float3 unpack98_g24 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, UVBase420_g24 ), _NormalStrength );
				unpack98_g24.z = lerp( 1, unpack98_g24.z, saturate(_NormalStrength) );
				float2 vertexToFrag432_g24 = packedInput.ase_texcoord8.xy;
				float2 UVThread440_g24 = vertexToFrag432_g24;
				float3 unpack475_g24 = UnpackNormalScale( SAMPLE_TEXTURE2D( _ThreadNormalMap, sampler_BumpMap, UVThread440_g24 ), _ThreadNormalStrength );
				unpack475_g24.z = lerp( 1, unpack475_g24.z, saturate(_ThreadNormalStrength) );
				float layeredBlendVar482_g24 = 0.5;
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;33;-266.323,92.28116;Inherit;False;Material Sample Fabirc;0;;24;17ec3236ec20390488bb6a4bcf57c048;5,263,1,486,1,527,1,543,1,389,1;0;8;FLOAT3;1;FLOAT3;6;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;45;-767.7166,95.25354;Inherit;False;489;169;Material Type - Specular Color;;0,0,0,1;Applies the Specular Color workflow to the Material. Use this Material Type to create Materials with a coloured specular highlight. $$This is similar to the built-in Specular Shader.;0;0
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;46;-762.7166,273.2536;Inherit;False;486;210;Energy Conserving Specular Color;;0,0,0,1;Enable the checkbox to make HDRP reduce the diffuse color of the Material if the specular effect is more intense. This makes the lighting of the Material more consistent, which makes the Material look more physically accurate.$$$This property only appears when you select Specular Color from the Material Type drop-down.;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;34;129.9,91.3;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;12;AmplifyShaderPack/Material Sample Fabric Standard;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;42;Category,InvertActionOnDeselection;0;0;  Instanced Terrain Normals;1;0;Surface Type;0;0;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;1;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;4;638263362398154499;  Energy Conserving Specular;1;0;  Transmission,InvertActionOnDeselection;0;0;Normal Space,InvertActionOnDeselection;0;0;Receive Decals,InvertActionOnDeselection;1;0;Receive SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Write Depth;0;0;  Depth Offset;0;0;  Conservative;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,True,_TessellationPhong;0;  Type;0;0;  Tess;16,True,_TessellationStrength;0;  Min;10,True,_TessellationDistanceMin;0;  Max;25,True,_TessellationDistanceMax;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;True;0
