	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord80_g33 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord81_g33 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord78_g33 = inputMesh.uv0.xy * float2( 2,2 ) + float2( 0,0 );
				...
				#endif
				float3 vertexValue = ( ( tex2DNode276 * float4( inputMesh.normalOS , 0.0 ) ) * _OffsetMultiplier ).rgb;
						 ...
						 )
			{
				...
				float4 color339 = IsGammaSpace() ? float4( 0, 0, 0, 0 ) : float4( 0, 0, 0, 0 );
				
				float2 temp_output_1_0_g33 = _NoiseMapSize;
				float2 texCoord80_g33 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult10_g33 = (float2(( (temp_output_1_0_g33).x * texCoord80_g33.x ) , ( texCoord80_g33.y * (temp_output_1_0_g33).y )));
				float2 temp_output_11_0_g33 = _NoiseMapPannerSpeed;
				float2 texCoord81_g33 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner18_g33 = ( ( (temp_output_11_0_g33).x * _TimeParameters.x ) * float2( 1,0 ) + texCoord81_g33);
				float2 panner19_g33 = ( ( _TimeParameters.x * (temp_output_11_0_g33).y ) * float2( 0,1 ) + texCoord81_g33);
				float2 appendResult24_g33 = (float2((panner18_g33).x , (panner19_g33).y));
				float2 temp_output_47_0_g33 = _RingPannerSpeed;
				float2 texCoord78_g33 = packedInput.ase_texcoord5.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_31_0_g33 = ( texCoord78_g33 - float2( 1,1 ) );
				float2 appendResult39_g33 = (float2(frac( ( atan2( (temp_output_31_0_g33).x , (temp_output_31_0_g33).y ) / TWO_PI ) ) , length( temp_output_31_0_g33 )));
				float2 panner54_g33 = ( ( (temp_output_47_0_g33).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g33);
				float2 panner55_g33 = ( ( _TimeParameters.x * (temp_output_47_0_g33).y ) * float2( 0,1 ) + appendResult39_g33);
				...
				float3 hdEmission322 = ASEGetEmissionHDRColor(( _Tint * tex2DNode276 ).rgb,_EmissionIntensity1,_EmissionWeight1,GetInverseCurrentExposureMultiplier());
				

				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;

				surfaceDescription.BaseColor = color339.rgb;
				...
				surfaceDescription.Emission = hdEmission322;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_output_1_0_g33 = _NoiseMapSize;
				float2 texCoord80_g33 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult10_g33 = (float2(( (temp_output_1_0_g33).x * texCoord80_g33.x ) , ( texCoord80_g33.y * (temp_output_1_0_g33).y )));
				float2 temp_output_11_0_g33 = _NoiseMapPannerSpeed;
				float2 texCoord81_g33 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner18_g33 = ( ( (temp_output_11_0_g33).x * _TimeParameters.x ) * float2( 1,0 ) + texCoord81_g33);
				float2 panner19_g33 = ( ( _TimeParameters.x * (temp_output_11_0_g33).y ) * float2( 0,1 ) + texCoord81_g33);
				float2 appendResult24_g33 = (float2((panner18_g33).x , (panner19_g33).y));
				float2 temp_output_47_0_g33 = _RingPannerSpeed;
				float2 texCoord78_g33 = packedInput.ase_texcoord2.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_31_0_g33 = ( texCoord78_g33 - float2( 1,1 ) );
				float2 appendResult39_g33 = (float2(frac( ( atan2( (temp_output_31_0_g33).x , (temp_output_31_0_g33).y ) / TWO_PI ) ) , length( temp_output_31_0_g33 )));
				float2 panner54_g33 = ( ( (temp_output_47_0_g33).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g33);
				float2 panner55_g33 = ( ( _TimeParameters.x * (temp_output_47_0_g33).y ) * float2( 0,1 ) + appendResult39_g33);
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 temp_output_1_0_g33 = _NoiseMapSize;
				float2 texCoord80_g33 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult10_g33 = (float2(( (temp_output_1_0_g33).x * texCoord80_g33.x ) , ( texCoord80_g33.y * (temp_output_1_0_g33).y )));
				float2 temp_output_11_0_g33 = _NoiseMapPannerSpeed;
				float2 texCoord81_g33 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner18_g33 = ( ( (temp_output_11_0_g33).x * _TimeParameters.x ) * float2( 1,0 ) + texCoord81_g33);
				float2 panner19_g33 = ( ( _TimeParameters.x * (temp_output_11_0_g33).y ) * float2( 0,1 ) + texCoord81_g33);
				float2 appendResult24_g33 = (float2((panner18_g33).x , (panner19_g33).y));
				float2 temp_output_47_0_g33 = _RingPannerSpeed;
				float2 texCoord78_g33 = inputMesh.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_31_0_g33 = ( texCoord78_g33 - float2( 1,1 ) );
				float2 appendResult39_g33 = (float2(frac( ( atan2( (temp_output_31_0_g33).x , (temp_output_31_0_g33).y ) / TWO_PI ) ) , length( temp_output_31_0_g33 )));
				float2 panner54_g33 = ( ( (temp_output_47_0_g33).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g33);
				float2 panner55_g33 = ( ( _TimeParameters.x * (temp_output_47_0_g33).y ) * float2( 0,1 ) + appendResult39_g33);
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 temp_output_1_0_g33 = _NoiseMapSize;
				float2 texCoord80_g33 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult10_g33 = (float2(( (temp_output_1_0_g33).x * texCoord80_g33.x ) , ( texCoord80_g33.y * (temp_output_1_0_g33).y )));
				float2 temp_output_11_0_g33 = _NoiseMapPannerSpeed;
				float2 texCoord81_g33 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner18_g33 = ( ( (temp_output_11_0_g33).x * _TimeParameters.x ) * float2( 1,0 ) + texCoord81_g33);
				float2 panner19_g33 = ( ( _TimeParameters.x * (temp_output_11_0_g33).y ) * float2( 0,1 ) + texCoord81_g33);
				float2 appendResult24_g33 = (float2((panner18_g33).x , (panner19_g33).y));
				float2 temp_output_47_0_g33 = _RingPannerSpeed;
				float2 texCoord78_g33 = packedInput.ase_texcoord7.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_31_0_g33 = ( texCoord78_g33 - float2( 1,1 ) );
				float2 appendResult39_g33 = (float2(frac( ( atan2( (temp_output_31_0_g33).x , (temp_output_31_0_g33).y ) / TWO_PI ) ) , length( temp_output_31_0_g33 )));
				float2 panner54_g33 = ( ( (temp_output_47_0_g33).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g33);
				float2 panner55_g33 = ( ( _TimeParameters.x * (temp_output_47_0_g33).y ) * float2( 0,1 ) + appendResult39_g33);
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;234;-98.52001,454.8504;Float;False;Property;_NoiseMapStrength;NoiseMapStrength;1;0;Create;True;0;0;0;False;0;False;0;0.6162086;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;241;-108.8479,333.3264;Float;False;Property;_NoiseMapPannerSpeed;NoiseMapPannerSpeed;4;0;Create;True;0;0;0;False;0;False;0,0;1.61,-0.43;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;240;-85.30761,719.762;Float;False;Property;_RingPannerSpeed;RingPannerSpeed;2;0;Create;True;0;0;0;False;0;False;0,0;0.1,-1.27;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;279;-56.4211,566.14;Float;False;Constant;_Vector0;Vector 0;7;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;233;-78.71893,10.57266;Float;True;Property;_NoiseMap;Noise Map;0;0;Create;True;0;0;0;False;0;False;None;937c2d88ef9b4e889d5a0a6a952c1a4b;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;239;-67.48209,204.02;Float;False;Property;_NoiseMapSize;NoiseMapSize;3;0;Create;True;0;0;0;False;0;False;512,512;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;316;251.7678,15.88756;Inherit;False;RadialUVDistortion;-1;;33;051d65e7699b41a4c800363fd0e822b2;0;7;60;SAMPLER2D;;False;1;FLOAT2;0,0;False;11;FLOAT2;0,0;False;65;FLOAT;0;False;68;FLOAT2;0,0;False;47;FLOAT2;0,0;False;29;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;276;690.1954,-9.195007;Inherit;True;Property;_BaseTexture;Base Texture;5;0;Create;True;0;0;0;False;0;False;-1;None;468c5859e2a9496ea1afdbc5cfce02ee;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.NormalVertexDataNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;335;822.7822,277.5183;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;336;1026.783,254.6027;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;338;1269.078,329.0146;Inherit;False;Property;_OffsetMultiplier;Offset Multiplier;10;0;Create;True;0;0;0;False;0;False;0;0.08;0;0;0;1;FLOAT;0
...
WireConnection;323;0;339;0
WireConnection;323;7;319;0
WireConnection;323;6;322;0
WireConnection;323;11;337;0
ASEEND*/
//CHKSM=8138A68EDCADC4642FEE8C6343295F0291AEBD05