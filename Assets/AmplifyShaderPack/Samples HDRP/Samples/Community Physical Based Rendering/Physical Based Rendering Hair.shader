	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction( AttributesMesh inputMesh  )
			{
				...
				float2 vertexToFrag795_g1 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.xy = vertexToFrag795_g1;
					...
					)
			{
				...
				float3 MainLightColor1902_g1 = ase_lightColor.rgb;
				float2 vertexToFrag795_g1 = packedInput.ase_texcoord1.xy;
				...
				float3 Normal_WS1160_g1 = worldNormal1159_g1;
				float3 Normal1367_g68765 = Normal_WS1160_g1;
				float3 Light_Dir1349_g68765 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				float dotResult682_g68765 = dot( Normal1367_g68765 , Light_Dir1349_g68765 );
				float temp_output_2827_108_g1 = dotResult682_g68765;
				float temp_output_2154_0_g1 = max( temp_output_2827_108_g1 , 0.0 );
				float Dot_NdotL208_g1 = temp_output_2154_0_g1;
				float smoothstepResult2137_g1 = smoothstep( 0.0 , 0.18 , Dot_NdotL208_g1);
				float3 Scene_Lighting1527_g1 = ( MainLightColor1902_g1 * smoothstepResult2137_g1 );
				float3 Indirect_Specular600_g1 = Scene_Lighting1527_g1;
				float4 tex2DNode35_g1 = tex2D( _MainTex, vertexToFrag795_g1 );
				float3 temp_output_12_0_g61632 = tex2DNode35_g1.rgb;
				float dotResult28_g61632 = dot( float3( 0.2126729, 0.7151522, 0.072175 ) , temp_output_12_0_g61632 );
				float3 temp_cast_1 = (dotResult28_g61632).xxx;
				float temp_output_21_0_g61632 = ( 1.0 - _Saturation );
				float3 lerpResult31_g61632 = lerp( temp_cast_1 , temp_output_12_0_g61632 , temp_output_21_0_g61632);
				float3 temp_output_48_0_g1 = ( _BaseColor * lerpResult31_g61632 * _Brightness );
				float3 lerpResult898_g1 = lerp( ( temp_output_48_0_g1 * _ShadowColor.rgb ) , _ShadowColor.rgb , _ShadowColor.a);
				float4 tex2DNode473_g1 = tex2D( _MainMaskMap, vertexToFrag795_g1 );
				float Occlusion435_g1 = saturate( (min( tex2DNode473_g1.b , packedInput.ase_color.a )*_OcclusionStrengthAO + ( 1.0 - _OcclusionStrengthAO )) );
				float3 Normal1367_g68764 = Normal_WS1160_g1;
				float3 View_Dir1334_g68764 = V;
				float dotResult735_g68764 = dot( Normal1367_g68764 , View_Dir1334_g68764 );
				float Dot_NdotV210_g1 = max( dotResult735_g68764 , 0.0 );
				float Dot_NdotL_total2267_g1 = Dot_NdotL208_g1;
				float3 Light_Dir1349_g68767 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				float3 View_Dir1334_g68767 = V;
				...
				float temp_output_2825_108_g1 = max( dotResult639_g68767 , 0.0 );
				float Dot_LdotH972_g1 = temp_output_2825_108_g1;
				float Dot_LdotH_Total2265_g1 = Dot_LdotH972_g1;
				float Shadow_65_g1 = pow( saturate( ( ( ( ( Dot_NdotV210_g1 * Dot_NdotL_total2267_g1 ) / ( Dot_LdotH_Total2265_g1 * max( Dot_NdotL_total2267_g1 , Dot_NdotV210_g1 ) ) ) * ( 1.0 - _ShadowStrength ) ) - _ShadowOffset ) ) , _ShadowFalloff );
				float3 lerpResult905_g1 = lerp( temp_output_48_0_g1 , ( lerpResult898_g1 * Occlusion435_g1 ) , ( ( 1.0 - Shadow_65_g1 ) * _ShadowColorEnable ));
				float3 _Color98_g68689 = lerpResult905_g1;
				float3 Specular_Map64_g1 = ( (_SpecularColor).rgb * (tex2D( _SpecularMap, vertexToFrag795_g1 )).rgb );
				float3 specRGB168_g68689 = Specular_Map64_g1;
				float Metallic403_g1 = ( _MetallicStrength * tex2DNode473_g1.r );
				float _Metallic711_g68689 = Metallic403_g1;
				...
				float temp_output_708_0_g68689 = Smoothness_417_g1;
				...
				float NdotV372_g68689 = Dot_NdotV210_g1;
				...
				float3 finalSpec683_g68689 = ( Indirect_Specular600_g1 * lerpResult670_g68689 * max( _Metallic711_g68689 , 0.15 ) * ( 1.0 - ( _Roughness707_g68689 * _Roughness707_g68689 * _Roughness707_g68689 ) ) );
				float NdotL373_g68689 = Dot_NdotL_total2267_g1;
				...
				float LdotH643_g68689 = Dot_LdotH_Total2265_g1;
				...
				float3 bakedGI607_g1 = ASEBakedGI( ase_positionWS, Normal_WS1160_g1, ( uint2 )( ScreenPosNorm.xy * _ScreenSize.xy ), (packedInput.ase_texcoord1.zw*(unity_LightmapST).xy + (unity_LightmapST).zw), (packedInput.ase_texcoord5.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw) );
				float3 Indirect_Diffuse644_g1 = ( bakedGI607_g1 * Occlusion435_g1 * _IndirectDiffuse );
				float3 diffuseColor77_g68689 = ( ( _Color98_g68689 * ( 1.0 - _Metallic711_g68689 ) * temp_output_336_0_g68690 ) + Indirect_Diffuse644_g1 );
				float geoShadow142_g68689 = Shadow_65_g1;
				...
				float temp_output_169_0_g68721 = saturate( ( 1.0 - Dot_LdotH972_g1 ) );
				float Fresnel_Term201_g1 = ( temp_output_1_0_g68721 + ( ( 1.0 - temp_output_1_0_g68721 ) * ( temp_output_169_0_g68721 * temp_output_169_0_g68721 * temp_output_169_0_g68721 * temp_output_169_0_g68721 * temp_output_169_0_g68721 ) ) );
				float fresnel104_g68689 = Fresnel_Term201_g1;
				float3 SpecFresnel431_g68689 = ( specColor651_g68689 + ( ( 1.0 - specColor651_g68689 ) * fresnel104_g68689 ) );
				float3 normalizeResult2731_g1 = normalize( ase_tangentWS );
				float3 Tangent_WS2280_g1 = normalizeResult2731_g1;
				float3 Tangent_WS1363_g68769 = Tangent_WS2280_g1;
				float3 View_Dir1334_g68769 = V;
				float3 Light_Dir1349_g68769 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				float3 normalizeResult600_g68769 = ASESafeNormalize( ( View_Dir1334_g68769 + Light_Dir1349_g68769 ) );
				float dotResult598_g68769 = dot( Tangent_WS1363_g68769 , normalizeResult600_g68769 );
				float Dot_HdotX970_g1 = dotResult598_g68769;
				float3 normalizeResult2732_g1 = normalize( ase_bitangentWS );
				float3 Bitangent_WS2279_g1 = normalizeResult2732_g1;
				float3 Bitangent_WS1365_g68768 = Bitangent_WS2279_g1;
				float3 View_Dir1334_g68768 = V;
				float3 Light_Dir1349_g68768 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				float3 normalizeResult926_g68768 = ASESafeNormalize( ( View_Dir1334_g68768 + Light_Dir1349_g68768 ) );
				float dotResult614_g68768 = dot( Bitangent_WS1365_g68768 , normalizeResult926_g68768 );
				float Dot_HdotY971_g1 = dotResult614_g68768;
				float2 appendResult485_g68725 = (float2(Dot_HdotX970_g1 , Dot_HdotY971_g1));
				float temp_output_2486_0_g1 = ( 1.0 - Smoothness_417_g1 );
				float temp_output_2485_0_g1 = ( temp_output_2486_0_g1 * temp_output_2486_0_g1 );
				float temp_output_2482_0_g1 = sqrt( ( 1.0 - ( _NDFAnistropic * 0.9 ) ) );
				float2 appendResult2487_g1 = (float2(( temp_output_2485_0_g1 / temp_output_2482_0_g1 ) , ( temp_output_2482_0_g1 * temp_output_2485_0_g1 )));
				float2 temp_cast_3 = (0.001).xx;
				float3 View_Dir1334_g68770 = V;
				float3 Light_Dir1349_g68770 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				float3 normalizeResult582_g68770 = ASESafeNormalize( ( View_Dir1334_g68770 + Light_Dir1349_g68770 ) );
				float dotResult585_g68770 = dot( normalizeResult582_g68770 , normalizeResult582_g68770 );
				float Dot_HdotH969_g1 = dotResult585_g68770;
				float3 appendResult487_g68725 = (float3(( appendResult485_g68725 / ( max( appendResult2487_g1 , temp_cast_3 ) * 5 ) ) , Dot_HdotH969_g1));
				float dotResult490_g68725 = dot( appendResult487_g68725 , appendResult487_g68725 );
				float2 break491_g68725 = ( max( appendResult2487_g1 , temp_cast_3 ) * 5 );
				#if ( SHADER_TARGET >= 50 )
				float recip56_g68725 = rcp( ( ( dotResult490_g68725 * dotResult490_g68725 ) * break491_g68725.x * break491_g68725.y * PI ) );
				#else
				float recip56_g68725 = 1.0 / ( ( dotResult490_g68725 * dotResult490_g68725 ) * break491_g68725.x * break491_g68725.y * PI );
				#endif
				float Specular200_g1 = recip56_g68725;
				float specularDistr105_g68689 = Specular200_g1;
				...
				float3 temp_output_829_0_g68689 = ( ( finalSpec683_g68689 + diffuseColor77_g68689 + specularity657_g68689 ) * Scene_Lighting1527_g1 * NdotL373_g68689 );
				float3 hdEmission2057_g1 = ASEGetEmissionHDRColor((_EmissiveColor).rgb,_EmissiveIntensity,_EmissiveExposureWeight,GetInverseCurrentExposureMultiplier());
				float3 BaseColor_Map63_g1 = temp_output_48_0_g1;
				float temp_output_2_0_g61649 = _AlbedoAffectEmissive;
				float temp_output_3_0_g61649 = ( 1.0 - temp_output_2_0_g61649 );
				float3 appendResult7_g61649 = (float3(temp_output_3_0_g61649 , temp_output_3_0_g61649 , temp_output_3_0_g61649));
				float3 Emission1553_g1 = ( ( ( (tex2D( _EmissiveColorMap, vertexToFrag795_g1 )).rgb * hdEmission2057_g1 ) * ( ( BaseColor_Map63_g1 * temp_output_2_0_g61649 ) + appendResult7_g61649 ) ) * _EmissionEnable );
				float3 LightDir_WS1116_g1 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				float3 ViewDir_WS1115_g1 = V;
				float dotResult1674_g1 = dot( -( LightDir_WS1116_g1 + ( Normal_WS1160_g1 * _TranslucencyNormalDistortion ) ) , ViewDir_WS1115_g1 );
				float3 temp_output_1450_0_g1 = ( (tex2D( _TranslucencyMap, vertexToFrag795_g1 )).rgb / max( _TranslucencyFeather , 0.1 ) );
				float3 lerpResult1441_g1 = lerp( temp_output_1450_0_g1 , ( 1.0 - temp_output_1450_0_g1 ) , _TranslucencyMapInverted);
				float3 Translucency1428_g1 = ( ( ( ( pow( saturate( dotResult1674_g1 ) , _TranslucencyScattering ) * _TranslucencyDirect ) + ( Indirect_Diffuse644_g1 * _TranslucencyAmbient ) ) * MainLightColor1902_g1 * BaseColor_Map63_g1 * lerpResult1441_g1 * (_TranslucencyColor).rgb * _TranslucencyStrength ) * _TranslucencyMapEnable );
				float Dot_NdotL_Inv1390_g1 = max( -temp_output_2827_108_g1 , 0.0 );
				float3 temp_output_1453_0_g1 = ( (tex2D( _TransmissionMap, vertexToFrag795_g1 )).rgb / max( _TransmissionFeather , 0.1 ) );
				float3 lerpResult1455_g1 = lerp( temp_output_1453_0_g1 , ( 1.0 - temp_output_1453_0_g1 ) , _TransmissionMapInverted);
				float3 temp_output_1713_0_g1 = (_TransmissionColor).rgb;
				float3 Transmission1400_g1 = ( ( Dot_NdotL_Inv1390_g1 * MainLightColor1902_g1 * BaseColor_Map63_g1 * ( lerpResult1455_g1 * temp_output_1713_0_g1 ) * _TransmissionStrength ) * _TransmissionMapEnable );
				
				float3 temp_output_102_0_g61650 = ( cross( ddx( PositionRWS ) , ddy( PositionRWS ) ) * _ProjectionParams.x );
				float3 normalizeResult79_g61650 = normalize( temp_output_102_0_g61650 );
				float dotResult149_g1 = dot( normalizeResult79_g61650 , ViewDir_WS1115_g1 );
				...
				surfaceDescription.Color = ( ( ( temp_output_829_0_g68689 + Emission1553_g1 ) + Translucency1428_g1 ) + Transmission1400_g1 );
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( lerpResult142_g1 * Alpha79_g1 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction( AttributesMesh inputMesh  )
			{
				...
				float2 vertexToFrag795_g1 = ( ( inputMesh.uv0.xy * (_MainUVs).xy ) + (_MainUVs).zw );
			...
			float4 Frag( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 ase_lightColor = float4( _DirectionalLightDatas[0].color.rgb / ase_lightIntensity, ase_lightIntensity );
				float3 MainLightColor1902_g1 = ase_lightColor.rgb;
				float2 vertexToFrag795_g1 = packedInput.ase_texcoord2.xy;
				float3 unpack12_g1 = UnpackNormalScale( tex2D( _BumpMap, vertexToFrag795_g1 ), _NormalStrength );
				unpack12_g1.z = lerp( 1, unpack12_g1.z, saturate(_NormalStrength) );
				...
				float3 bakedGI607_g1 = ASEBakedGI( ase_positionWS, Normal_WS1160_g1, ( uint2 )( ase_positionSSNorm.xy * _ScreenSize.xy ), (packedInput.ase_texcoord2.zw*(unity_LightmapST).xy + (unity_LightmapST).zw), (packedInput.ase_texcoord7.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw) );
				float3 Indirect_Diffuse644_g1 = ( bakedGI607_g1 * Occlusion435_g1 * _IndirectDiffuse );
				float3 diffuseColor77_g68689 = ( ( _Color98_g68689 * ( 1.0 - _Metallic711_g68689 ) * temp_output_336_0_g68690 ) + Indirect_Diffuse644_g1 );
				float geoShadow142_g68689 = Shadow_65_g1;
				float clampResult7_g68721 = clamp( _fresnelIOR , 1.0 , 4.0 );
				...
				float3 Tangent_WS2280_g1 = normalizeResult2731_g1;
				float3 Tangent_WS1363_g68769 = Tangent_WS2280_g1;
				float3 View_Dir1334_g68769 = ase_viewDirSafeWS;
				float3 Light_Dir1349_g68769 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				float3 normalizeResult600_g68769 = ASESafeNormalize( ( View_Dir1334_g68769 + Light_Dir1349_g68769 ) );
				float dotResult598_g68769 = dot( Tangent_WS1363_g68769 , normalizeResult600_g68769 );
				float Dot_HdotX970_g1 = dotResult598_g68769;
				...
				float3 Bitangent_WS2279_g1 = normalizeResult2732_g1;
				float3 Bitangent_WS1365_g68768 = Bitangent_WS2279_g1;
				float3 View_Dir1334_g68768 = ase_viewDirSafeWS;
				float3 Light_Dir1349_g68768 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				float3 normalizeResult926_g68768 = ASESafeNormalize( ( View_Dir1334_g68768 + Light_Dir1349_g68768 ) );
				float dotResult614_g68768 = dot( Bitangent_WS1365_g68768 , normalizeResult926_g68768 );
				float Dot_HdotY971_g1 = dotResult614_g68768;
				...
				float2 appendResult2487_g1 = (float2(( temp_output_2485_0_g1 / temp_output_2482_0_g1 ) , ( temp_output_2482_0_g1 * temp_output_2485_0_g1 )));
				float2 temp_cast_3 = (0.001).xx;
				float3 View_Dir1334_g68770 = ase_viewDirSafeWS;
				float3 Light_Dir1349_g68770 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				float3 normalizeResult582_g68770 = ASESafeNormalize( ( View_Dir1334_g68770 + Light_Dir1349_g68770 ) );
				float dotResult585_g68770 = dot( normalizeResult582_g68770 , normalizeResult582_g68770 );
				float Dot_HdotH969_g1 = dotResult585_g68770;
				...
				float3 Emission1553_g1 = ( ( ( (tex2D( _EmissiveColorMap, vertexToFrag795_g1 )).rgb * hdEmission2057_g1 ) * ( ( BaseColor_Map63_g1 * temp_output_2_0_g61649 ) + appendResult7_g61649 ) ) * _EmissionEnable );
				float3 LightDir_WS1116_g1 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				float3 ViewDir_WS1115_g1 = ase_viewDirSafeWS;
				float dotResult1674_g1 = dot( -( LightDir_WS1116_g1 + ( Normal_WS1160_g1 * _TranslucencyNormalDistortion ) ) , ViewDir_WS1115_g1 );
				float3 temp_output_1450_0_g1 = ( (tex2D( _TranslucencyMap, vertexToFrag795_g1 )).rgb / max( _TranslucencyFeather , 0.1 ) );
				float3 lerpResult1441_g1 = lerp( temp_output_1450_0_g1 , ( 1.0 - temp_output_1450_0_g1 ) , _TranslucencyMapInverted);
				float3 Translucency1428_g1 = ( ( ( ( pow( saturate( dotResult1674_g1 ) , _TranslucencyScattering ) * _TranslucencyDirect ) + ( Indirect_Diffuse644_g1 * _TranslucencyAmbient ) ) * MainLightColor1902_g1 * BaseColor_Map63_g1 * lerpResult1441_g1 * (_TranslucencyColor).rgb * _TranslucencyStrength ) * _TranslucencyMapEnable );
				...
				float3 temp_output_102_0_g61650 = ( cross( ddx( ase_positionRWS ) , ddy( ase_positionRWS ) ) * _ProjectionParams.x );
				float3 normalizeResult79_g61650 = normalize( temp_output_102_0_g61650 );
				float dotResult149_g1 = dot( normalizeResult79_g61650 , ViewDir_WS1115_g1 );
				float temp_output_147_0_g1 = ( 1.0 - abs( dotResult149_g1 ) );
				#ifdef UNITY_PASS_SHADOWCASTER
		...
		Pass
		{
					...
					)
			{
				...
				#endif
				float lerpResult142_g1 = lerp( 1.0 , staticSwitch143_g1 , _GlancingClipMode);
				float2 vertexToFrag795_g1 = packedInput.ase_texcoord4.xy;
				float4 tex2DNode35_g1 = tex2D( _MainTex, vertexToFrag795_g1 );
				float Alpha79_g1 = tex2DNode35_g1.a;
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.StickyNoteNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;160;0,-160;Inherit;False;291.9852;124.964;Physical Based Rendering Hair;;0,0,0,1;Physical Based Rendering Hair$-- GSF Ashikhmin Shirley$-- NDF Trowbridge Reitz Anisotropic$-- Schlick IOR Fresnel$;0;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;157;0,0;Inherit;False;PBR Core;0;;1;d226ce46eb9ddb04ba9f0a949b5fddfe;21,213,1,2520,5,240,5,215,2,536,0,545,1,1279,1,908,1,1588,1,1886,1,1463,0,1887,1,2285,0,2543,0,2239,0,2242,0,2246,0,2243,0,2706,0,2235,0,2756,0;0;4;FLOAT3;0;FLOAT;156;FLOAT;159;FLOAT;158
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;147;384,0;Float;False;True;-1;2;Rendering.HighDefinition.HDUnlitGUI;0;13;AmplifyShaderPack/Community/Physical Based Rendering Hair;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;11;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;True;3;1;False;;10;False;;0;1;False;;0;False;;False;False;True;1;1;False;;0;True;_DstBlend2;0;1;False;;0;False;;False;False;True;1;1;False;;0;True;_DstBlend2;0;1;False;;0;False;;False;False;False;True;0;True;_CullModeForward;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestDepthEqualForOpaque;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;33;Surface Type;0;0;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;1;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;638536614165647587;Alpha Clipping;1;638529938641995424;Receive Decals;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;638532222225255026;Shadow Matte;0;0;Cast Shadows;1;0;Write Depth;0;0;  Depth Offset;0;0;  Conservative;0;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;True;True;True;True;True;False;True;False;;False;0
...
WireConnection;147;2;157;156
WireConnection;147;3;157;159
ASEEND*/
//CHKSM=FB77E5AB2C1B025ADEF616A1AE2EED80A512814B