	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float3 Normal1367_g68763 = Normal_WS1160_g1;
				float3 View_Dir1334_g68763 = V;
				float3 Light_Dir1349_g68763 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				...
				float temp_output_2829_108_g1 = max( dotResult713_g68763 , 0.0 );
				float Dot_NdotH655_g1 = temp_output_2829_108_g1;
				float Dot_NdotH_Total2269_g1 = Dot_NdotH655_g1;
				float2 appendResult375_g68421 = (float2(Dot_NdotV210_g1 , Dot_NdotH_Total2269_g1));
				float Dot_NdotL_total2267_g1 = Dot_NdotL208_g1;
				float2 appendResult376_g68421 = (float2(Dot_NdotH_Total2269_g1 , Dot_NdotL_total2267_g1));
				float3 View_Dir1334_g68761 = V;
				float3 Light_Dir1349_g68761 = SafeNormalize( -_DirectionalLightDatas[0].forward );
				...
				float temp_output_2831_108_g1 = max( dotResult812_g68761 , 0.0 );
				float Dot_VdotH975_g1 = temp_output_2831_108_g1;
				float Dot_VdotH_Total2270_g1 = Dot_VdotH975_g1;
				float2 break372_g68421 = ( ( appendResult375_g68421 * appendResult376_g68421 * 2.0 ) / Dot_VdotH_Total2270_g1 );
				float Shadow_65_g1 = pow( saturate( ( ( min( min( break372_g68421.x , break372_g68421.y ) , 1.0 ) * ( 1.0 - _ShadowStrength ) ) - _ShadowOffset ) ) , _ShadowFalloff );
				...
				float Fresnel_Term201_g1 = pow( saferPower14_g68492 , ( Dot_LdotH972_g1 * ( ( Dot_LdotH972_g1 * _GaussianApprox.x ) - _GaussianApprox.y ) ) );
				...
				float temp_output_96_0_g68356 = acos( Dot_NdotH_Total2269_g1 );
				float temp_output_53_0_g1 = ( temp_output_414_0_g1 * temp_output_414_0_g1 );
				float temp_output_47_0_g1 = ( 1.0 - temp_output_53_0_g1 );
				float Roughness730_g1 = ( temp_output_47_0_g1 * temp_output_47_0_g1 );
				float temp_output_226_0_g68356 = Roughness730_g1;
				float Specular200_g1 = exp( ( -( temp_output_96_0_g68356 * temp_output_96_0_g68356 ) / max( ( temp_output_226_0_g68356 * temp_output_226_0_g68356 ) , 0.0001 ) ) );
...
ASEEND*/
//CHKSM=041B277EC3101B2CDD581A10137122D5AEAA695B