	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord9 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + panner11;
				float2 uv_DistortTexture = packedInput.ase_texcoord5.xy * _DistortTexture_ST.xy + _DistortTexture_ST.zw;
				...
				float2 texCoord18 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + panner17;
				...
				float3 hdEmission37 = ASEGetEmissionHDRColor(temp_output_20_0.rgb,_EmissionIntensity1,_EmissionWeight1,GetInverseCurrentExposureMultiplier());
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float mulTime10 = _TimeParameters.x * _Speed;
				float2 panner11 = ( mulTime10 * float2( -1,-1 ) + float2( 0,0 ));
				float2 texCoord9 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + panner11;
				float2 uv_DistortTexture = packedInput.ase_texcoord2.xy * _DistortTexture_ST.xy + _DistortTexture_ST.zw;
				float3 unpack6 = UnpackNormalScale( tex2D( _DistortTexture, uv_DistortTexture ), _UVDistortIntensity );
				unpack6.z = lerp( 1, unpack6.z, saturate(_UVDistortIntensity) );
				float3 tex2DNode6 = unpack6;
				float mulTime15 = _TimeParameters.x * _Speed;
				float2 panner17 = ( mulTime15 * float2( 1,0.5 ) + float2( 0,0 ));
				float2 texCoord18 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + panner17;
				float4 temp_output_20_0 = ( _TintColor * ( tex2D( _MainTexture, ( float3( texCoord9 ,  0.0 ) + tex2DNode6 ).xy ) * tex2D( _MainTexture, ( float3( texCoord18 ,  0.0 ) + tex2DNode6 ).xy ) ) );
		...
		Pass
		{
					 ...
					 )
			{
				...
				float mulTime10 = _TimeParameters.x * _Speed;
				float2 panner11 = ( mulTime10 * float2( -1,-1 ) + float2( 0,0 ));
				float2 texCoord9 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + panner11;
				float2 uv_DistortTexture = packedInput.ase_texcoord7.xy * _DistortTexture_ST.xy + _DistortTexture_ST.zw;
				float3 unpack6 = UnpackNormalScale( tex2D( _DistortTexture, uv_DistortTexture ), _UVDistortIntensity );
				unpack6.z = lerp( 1, unpack6.z, saturate(_UVDistortIntensity) );
				float3 tex2DNode6 = unpack6;
				float mulTime15 = _TimeParameters.x * _Speed;
				float2 panner17 = ( mulTime15 * float2( 1,0.5 ) + float2( 0,0 ));
				float2 texCoord18 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + panner17;
				float4 temp_output_20_0 = ( _TintColor * ( tex2D( _MainTexture, ( float3( texCoord9 ,  0.0 ) + tex2DNode6 ).xy ) * tex2D( _MainTexture, ( float3( texCoord18 ,  0.0 ) + tex2DNode6 ).xy ) ) );
...
WireConnection;24;6;37;0
ASEEND*/
//CHKSM=33DE2379055B68441061F09A3952172F20C8BF16