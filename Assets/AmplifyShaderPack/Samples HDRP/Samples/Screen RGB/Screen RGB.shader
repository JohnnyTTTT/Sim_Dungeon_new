	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord80_g48 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord81_g48 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord78_g48 = packedInput.ase_texcoord5.xy * float2( 2,2 ) + float2( 0,0 );
				...
				float3 hdEmission178 = ASEGetEmissionHDRColor(( _Tint * clampResult55 ).rgb,_EmissionIntensity1,_EmissionWeight1,GetInverseCurrentExposureMultiplier());
				...
				surfaceDescription.Emission = hdEmission178;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_output_1_0_g48 = _NoiseMapSize;
				float2 texCoord80_g48 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult10_g48 = (float2(( (temp_output_1_0_g48).x * texCoord80_g48.x ) , ( texCoord80_g48.y * (temp_output_1_0_g48).y )));
				float2 temp_output_11_0_g48 = _NoiseMapPannerSpeed;
				float2 texCoord81_g48 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner18_g48 = ( ( (temp_output_11_0_g48).x * _TimeParameters.x ) * float2( 1,0 ) + texCoord81_g48);
				float2 panner19_g48 = ( ( _TimeParameters.x * (temp_output_11_0_g48).y ) * float2( 0,1 ) + texCoord81_g48);
				float2 appendResult24_g48 = (float2((panner18_g48).x , (panner19_g48).y));
				float2 temp_output_47_0_g48 = _RingPannerSpeed;
				float2 texCoord78_g48 = packedInput.ase_texcoord2.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_31_0_g48 = ( texCoord78_g48 - float2( 1,1 ) );
				float2 appendResult39_g48 = (float2(frac( ( atan2( (temp_output_31_0_g48).x , (temp_output_31_0_g48).y ) / TWO_PI ) ) , length( temp_output_31_0_g48 )));
				float2 panner54_g48 = ( ( (temp_output_47_0_g48).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g48);
				float2 panner55_g48 = ( ( _TimeParameters.x * (temp_output_47_0_g48).y ) * float2( 0,1 ) + appendResult39_g48);
				float2 appendResult58_g48 = (float2((panner54_g48).x , (panner55_g48).y));
				float2 uv_Base = packedInput.ase_texcoord2.xy * _Base_ST.xy + _Base_ST.zw;
				float clampResult147 = clamp( sin( _TimeParameters.x ) , 0.2 , 0.8 );
				float4 lerpResult142 = lerp( tex2D( _Overlay, ( ( (tex2D( _NoiseMap, ( appendResult10_g48 + appendResult24_g48 ) )).rg * _NoiseMapStrength ) + ( float2( 1,1 ) * appendResult58_g48 ) ) ) , tex2D( _Base, uv_Base ) , clampResult147);
				float4 clampResult53 = clamp( lerpResult142 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 break44 = clampResult53;
				float2 texCoord38 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode37 = tex2D( _RGB, ( texCoord38 * float2( 350,350 ) ) );
				float4 appendResult47 = (float4(( break44.r * tex2DNode37.r ) , ( break44.g * tex2DNode37.g ) , ( break44.b * tex2DNode37.b ) , break44.a));
				float mulTime155 = _TimeParameters.x * 3.0;
				float4 clampResult55 = clamp( ( appendResult47 * ( _Intensity + sin( mulTime155 ) ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 temp_output_1_0_g48 = _NoiseMapSize;
				float2 texCoord80_g48 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult10_g48 = (float2(( (temp_output_1_0_g48).x * texCoord80_g48.x ) , ( texCoord80_g48.y * (temp_output_1_0_g48).y )));
				float2 temp_output_11_0_g48 = _NoiseMapPannerSpeed;
				float2 texCoord81_g48 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner18_g48 = ( ( (temp_output_11_0_g48).x * _TimeParameters.x ) * float2( 1,0 ) + texCoord81_g48);
				float2 panner19_g48 = ( ( _TimeParameters.x * (temp_output_11_0_g48).y ) * float2( 0,1 ) + texCoord81_g48);
				float2 appendResult24_g48 = (float2((panner18_g48).x , (panner19_g48).y));
				float2 temp_output_47_0_g48 = _RingPannerSpeed;
				float2 texCoord78_g48 = packedInput.ase_texcoord7.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_31_0_g48 = ( texCoord78_g48 - float2( 1,1 ) );
				float2 appendResult39_g48 = (float2(frac( ( atan2( (temp_output_31_0_g48).x , (temp_output_31_0_g48).y ) / TWO_PI ) ) , length( temp_output_31_0_g48 )));
				float2 panner54_g48 = ( ( (temp_output_47_0_g48).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult39_g48);
				float2 panner55_g48 = ( ( _TimeParameters.x * (temp_output_47_0_g48).y ) * float2( 0,1 ) + appendResult39_g48);
...
WireConnection;179;6;178;0
ASEEND*/
//CHKSM=6B5B6EE02805E617E51BAA9F7D3AC2B64F50563B