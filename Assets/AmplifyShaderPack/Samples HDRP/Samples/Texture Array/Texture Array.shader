	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_TextureArrayAlbedo = packedInput.ase_texcoord5.xy;
				
				float2 uv_TextureArrayNormal = packedInput.ase_texcoord5.xy;
				float3 unpack103 = UnpackNormalScale( SAMPLE_TEXTURE2D_ARRAY( _TextureArrayNormal, sampler_TextureArrayNormal, uv_TextureArrayNormal,_AlbedoIndex ), _NormalScale );
				unpack103.z = lerp( 1, unpack103.z, saturate(_NormalScale) );
				

				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;

				surfaceDescription.BaseColor = SAMPLE_TEXTURE2D_ARRAY( _TextureArrayAlbedo, sampler_TextureArrayAlbedo, uv_TextureArrayAlbedo,_AlbedoIndex ).rgb;
				surfaceDescription.Normal = unpack103;
				...
				surfaceDescription.Smoothness = ( SAMPLE_TEXTURE2D_ARRAY( _TextureArrayAlbedo, sampler_TextureArrayAlbedo, uv_TextureArrayAlbedo,_AlbedoIndex ).r * _RoughScale );
				surfaceDescription.Occlusion = SAMPLE_TEXTURE2D_ARRAY( _TextureArrayAlbedo, sampler_TextureArrayAlbedo, uv_TextureArrayAlbedo,_AlbedoIndex ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_TextureArrayAlbedo = packedInput.ase_texcoord2.xy;
				
				float2 uv_TextureArrayNormal = packedInput.ase_texcoord2.xy;
				float3 unpack103 = UnpackNormalScale( SAMPLE_TEXTURE2D_ARRAY( _TextureArrayNormal, sampler_TextureArrayNormal, uv_TextureArrayNormal,_AlbedoIndex ), _NormalScale );
				unpack103.z = lerp( 1, unpack103.z, saturate(_NormalScale) );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_TextureArrayNormal = packedInput.ase_texcoord3.xy;
				float3 unpack103 = UnpackNormalScale( SAMPLE_TEXTURE2D_ARRAY( _TextureArrayNormal, sampler_TextureArrayNormal, uv_TextureArrayNormal,_AlbedoIndex ), _NormalScale );
				unpack103.z = lerp( 1, unpack103.z, saturate(_NormalScale) );
				
				float2 uv_TextureArrayAlbedo = packedInput.ase_texcoord3.xy;
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 uv_TextureArrayAlbedo = packedInput.ase_texcoord7.xy;
				
				float2 uv_TextureArrayNormal = packedInput.ase_texcoord7.xy;
				float3 unpack103 = UnpackNormalScale( SAMPLE_TEXTURE2D_ARRAY( _TextureArrayNormal, sampler_TextureArrayNormal, uv_TextureArrayNormal,_AlbedoIndex ), _NormalScale );
				unpack103.z = lerp( 1, unpack103.z, saturate(_NormalScale) );
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;109;-560,64;Float;False;Constant;_RoughnessIndex;Roughness Index;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;110;-544,320;Float;False;Constant;_OcclusionIndex;Occlusion Index;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;111;-560,-176;Float;False;Constant;_NormalIndex;Normal Index;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;123;-560,-80;Float;False;Property;_NormalScale;Normal Scale;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;118;-304,240;Float;False;Property;_RoughScale;Rough Scale;4;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;103;-304,-192;Inherit;True;Property;_TextureArrayNormal;Texture Array Normal;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2DArray;False;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;108;-306.7961,-432.2489;Inherit;True;Property;_TextureArrayAlbedo;Texture Array Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2DArray;False;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
