	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 normalizeResult23 = normalize( ase_viewDirTS );
				float dotResult21 = dot( tex2DNode3 , normalizeResult23 );
				float3 hdEmission42 = ASEGetEmissionHDRColor(_RimColor.rgb,_EmissionIntensity,_EmissionWeight,GetInverseCurrentExposureMultiplier());
				...
				surfaceDescription.Metallic = tex2D( _Metallic, uv_Metallic ).r;
				...
				surfaceDescription.Emission = ( pow( ( 1.0 - saturate( dotResult21 ) ) , _RimPower ) * hdEmission42 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_Normals = packedInput.ase_texcoord3.xy * _Normals_ST.xy + _Normals_ST.zw;
				float3 tex2DNode3 = UnpackNormalScale( tex2D( _Normals, uv_Normals ), 1.0f );
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 uv_Normals = packedInput.ase_texcoord7.xy * _Normals_ST.xy + _Normals_ST.zw;
				float3 tex2DNode3 = UnpackNormalScale( tex2D( _Normals, uv_Normals ), 1.0f );
...
WireConnection;29;4;2;0
WireConnection;29;8;4;0
WireConnection;29;6;27;0
ASEEND*/
//CHKSM=AEA6F2E6BAB493BCBB9613C20AFA4FE4A89AB1EF