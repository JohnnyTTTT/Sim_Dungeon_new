	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 temp_output_194_0_g1 = reflect( V , normalizedWorldNormal );
				...
				surfaceDescription.BaseColor = SAMPLE_TEXTURE2D_GRAD( _LatLongMap, sampler_LatLongMap, ( appendResult357_g1 * float2( 0.1591549,-0.3183099 ) ), ddx( packedInput.ase_texcoord5.xy ), ddy( packedInput.ase_texcoord5.xy ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 temp_output_194_0_g1 = reflect( ase_viewDirSafeWS , normalizedWorldNormal );
				float3 break350_g1 = temp_output_194_0_g1;
				float2 appendResult357_g1 = (float2(( atan2( break350_g1.z , break350_g1.x ) + 1.570796 ) , ( ( -0.5 * PI ) + asin( (temp_output_194_0_g1).y ) )));
				...
				surfaceDescription.BaseColor = SAMPLE_TEXTURE2D_GRAD( _LatLongMap, sampler_LatLongMap, ( appendResult357_g1 * float2( 0.1591549,-0.3183099 ) ), ddx( packedInput.ase_texcoord4.xy ), ddy( packedInput.ase_texcoord4.xy ) ).rgb;
				surfaceDescription.Normal = float3( 0, 0, 1 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;
		...
		Pass
		{
					 ...
					 )
			{
				...
				surfaceDescription.BaseColor = SAMPLE_TEXTURE2D_GRAD( _LatLongMap, sampler_LatLongMap, ( appendResult357_g1 * float2( 0.1591549,-0.3183099 ) ), ddx( packedInput.ase_texcoord7.xy ), ddy( packedInput.ase_texcoord7.xy ) ).rgb;
				surfaceDescription.Normal = float3( 0, 0, 1 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;
...
WireConnection;332;194;346;0
WireConnection;346;0;330;0
WireConnection;346;1;331;0
WireConnection;335;0;327;0
ASEEND*/
//CHKSM=C44479E52012F718EED485EBC692C5A16CAF78BD