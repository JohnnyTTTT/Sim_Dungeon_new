	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction( AttributesMesh inputMesh  )
			{
				...
				inputMesh.ase_tangent.xyz = normalize( mul( float4( inputMesh.ase_tangent.xyz , 0 ), rotationCamMatrix )).xyz;
				...
				float3 normalizeResult8_g12 = normalize( ( (float4( GetObjectToWorldMatrix()[ 0 ][ 3 ], GetObjectToWorldMatrix()[ 1 ][ 3 ], GetObjectToWorldMatrix()[ 2 ][ 3 ], GetObjectToWorldMatrix()[ 3 ][ 3 ] )).xyz - _WorldSpaceCameraPos ) );
				...
				float2 texCoord29_g12 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_43_0_g12 = texCoord29_g12;
				float2 break44_g12 = temp_output_43_0_g12;
				float temp_output_45_0_g12 = _Columns;
				float2 appendResult36_g12 = (float2(( ( floor( ( ( atan2( break11_g12.z , break11_g12.x ) + PI ) / ( TWO_PI / temp_output_41_0_g12 ) ) ) * temp_output_28_0_g12 ) + ( temp_output_28_0_g12 * break44_g12.x ) ) , (( ( break44_g12.y + ( temp_output_45_0_g12 - fmod( ( 1.0 + round( ( _AnimSpeed * ( _TimeParameters.x ) ) ) ) , temp_output_45_0_g12 ) ) ) / temp_output_45_0_g12 )).x));
					...
					)
			{
				...
				float2 vertexToFrag37_g12 = packedInput.ase_texcoord1.xy;
				float4 temp_output_635_0 = tex2D( _Spritesheet, vertexToFrag37_g12 );
				

				SurfaceDescription surfaceDescription = (SurfaceDescription)0;

				surfaceDescription.Color = (temp_output_635_0).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = (temp_output_635_0).a;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction( AttributesMesh inputMesh  )
			{
				...
				float temp_output_41_0_g12 = _Rows;
				float temp_output_28_0_g12 = ( 1.0 / temp_output_41_0_g12 );
				float2 texCoord29_g12 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_43_0_g12 = texCoord29_g12;
				float2 break44_g12 = temp_output_43_0_g12;
				float temp_output_45_0_g12 = _Columns;
				float2 appendResult36_g12 = (float2(( ( floor( ( ( atan2( break11_g12.z , break11_g12.x ) + PI ) / ( TWO_PI / temp_output_41_0_g12 ) ) ) * temp_output_28_0_g12 ) + ( temp_output_28_0_g12 * break44_g12.x ) ) , (( ( break44_g12.y + ( temp_output_45_0_g12 - fmod( ( 1.0 + round( ( _AnimSpeed * ( _TimeParameters.x ) ) ) ) , temp_output_45_0_g12 ) ) ) / temp_output_45_0_g12 )).x));
				float2 vertexToFrag37_g12 = appendResult36_g12;
				o.ase_texcoord2.xy = vertexToFrag37_g12;
			...
			float4 Frag( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 vertexToFrag37_g12 = packedInput.ase_texcoord2.xy;
				float4 temp_output_635_0 = tex2D( _Spritesheet, vertexToFrag37_g12 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 vertexToFrag37_g12 = packedInput.ase_texcoord.xy;
				float4 temp_output_635_0 = tex2D( _Spritesheet, vertexToFrag37_g12 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS o )
			{
				...
				float2 appendResult36_g12 = (float2(( ( floor( ( ( atan2( break11_g12.z , break11_g12.x ) + PI ) / ( TWO_PI / temp_output_41_0_g12 ) ) ) * temp_output_28_0_g12 ) + ( temp_output_28_0_g12 * break44_g12.x ) ) , (( ( break44_g12.y + ( temp_output_45_0_g12 - fmod( ( 1.0 + round( ( _AnimSpeed * ( _TimeParameters.x ) ) ) ) , temp_output_45_0_g12 ) ) ) / temp_output_45_0_g12 )).x));
				float2 vertexToFrag37_g12 = appendResult36_g12;
				o.ase_texcoord3.xy = vertexToFrag37_g12;
					...
					)
			{
				...
				float2 vertexToFrag37_g12 = packedInput.ase_texcoord3.xy;
				float4 temp_output_635_0 = tex2D( _Spritesheet, vertexToFrag37_g12 );
...
WireConnection;636;2;624;0
WireConnection;636;6;644;0
ASEEND*/
//CHKSM=505A1F897EB111B91DC860965BE8A225D535D0DD