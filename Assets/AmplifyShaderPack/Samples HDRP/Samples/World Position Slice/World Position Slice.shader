	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				surfaceDescription.Alpha = ( frac( ( ( PositionWS.y + ( PositionWS.z * 0.1 ) ) * 5.0 ) ) - _Thickness );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( frac( ( ( ase_positionWS.y + ( ase_positionWS.z * 0.1 ) ) * 5.0 ) ) - _Thickness );
...
WireConnection;11;10;24;0
ASEEND*/
//CHKSM=4EF0F3714E7CFEA7BDC01B8F79705FAA05638292