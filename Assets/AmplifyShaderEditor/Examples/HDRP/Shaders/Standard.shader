	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				surfaceDescription.BaseColor = ( tex2D( _BaseMap, uv_BaseMap ) * tex2D( _MixAlbedo, texCoord16 ) ).rgb;
...
ASEEND*/
//CHKSM=A441C827499B3CB103FA928E7982E04072247DDA