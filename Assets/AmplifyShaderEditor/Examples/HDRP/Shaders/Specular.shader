	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				surfaceDescription.BaseColor = ( tex2D( _BaseMap, uv_BaseMap ) * tex2D( _MixAlbedo, uv_MixAlbedo ) ).rgb;
...
ASEEND*/
//CHKSM=18510111823F1A22F68B0D2C62DCB02F48993B50