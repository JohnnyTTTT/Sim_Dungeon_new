    ...
    SubShader
    {
        ...
        Pass
		{
			...
			)
			{
				...
				float fbcurrenttileindex27 = floor( fmod( fbspeed27 + _DecalType, fbtotaltiles27) );
				...
				// Flipbook UV
				float2 fbuv27 = texCoord25 * fbtiling27 + fboffset27;
				// *** END Flipbook UV Animation vars ***
				int flipbookFrame27 = ( ( int )fbcurrenttileindex27);
...
ASEEND*/
//CHKSM=6B6A7268D13C898AB02EB8C8B8C5A3188D3F505D