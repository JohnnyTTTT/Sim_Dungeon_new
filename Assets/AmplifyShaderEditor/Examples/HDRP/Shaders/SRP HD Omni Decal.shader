...
Shader "ASESampleShaders/Omni Decal/SRP HD Omni Decal"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 UV22_g9 = ScreenPosNorm.xy;
				float2 localUnStereo22_g9 = UnStereo( UV22_g9 );
				float2 break64_g8 = localUnStereo22_g9;
				float depth01_69_g8 = SampleCameraDepth( ScreenPosNorm.xy );
				#ifdef UNITY_REVERSED_Z
				float staticSwitch38_g8 = ( 1.0 - depth01_69_g8 );
				#else
				float staticSwitch38_g8 = depth01_69_g8;
				#endif
		...
		Pass
		{
			...
			float4 Frag( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 UV22_g9 = ase_positionSSNorm.xy;
				float2 localUnStereo22_g9 = UnStereo( UV22_g9 );
				float2 break64_g8 = localUnStereo22_g9;
				float depth01_69_g8 = SampleCameraDepth( ase_positionSSNorm.xy );
				#ifdef UNITY_REVERSED_Z
				float staticSwitch38_g8 = ( 1.0 - depth01_69_g8 );
				#else
				float staticSwitch38_g8 = depth01_69_g8;
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;232;1256.361,701.5815;Inherit;False;Reconstruct World Position From Depth;-1;;8;e7094bcbcc80eb140b2a3dbe6a861de8;0;0;1;FLOAT4;0
...
Node;AmplifyShaderEditor.PowerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;163;2736,496;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=00A2F1933E2CF4C580CF64354BCC8AAF9C434C3B